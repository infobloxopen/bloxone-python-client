...
class AnycastConfigRef(BaseModel):
    """
    AnycastConfigRef
    """

  # noqa: E501
    anycast_config_name: Optional[StrictStr] = None
    routing_protocols: Optional[List[StrictStr]] = Field(
        default=None,
        description=
    ...
    __properties: ClassVar[List[str]] = [
        "anycast_config_name", "routing_protocols"
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "anycast_config_name":
            obj.get("anycast_config_name"),
            "routing_protocols":
            obj.get("routing_protocols")
        })
