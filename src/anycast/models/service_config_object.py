...
class ServiceConfigObject(BaseModel):
    """
    ServiceConfigObject
    """

  # noqa: E501
    config_body: Optional[Union[Annotated[bytes, Field(strict=True)],
                                Annotated[str, Field(strict=True)]]] = Field(
                                    default=None, alias="configBody")
    ophid: Optional[StrictStr] = None
    version: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["configBody", "ophid", "version"]

    @field_validator('config_body')
    def config_body_validate_regular_expression(cls, value):
