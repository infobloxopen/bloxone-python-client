...
class OnPremAnycastManagerApi:
    ...
    def CreateAnycastConfig_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnycastConfigResponse]:
        """Create Anycast Configuration
    ...
    def _CreateAnycastConfig_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/api/anycast/v1',
            resource_path='/accm/ac_configs',
    ...
    def _CreateAnycastVersion_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/api/anycast/v1',
            resource_path='/accm/ac_version/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _DeleteAnycastConfig_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            base_path='/api/anycast/v1',
            resource_path='/accm/ac_configs/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _DeleteOnpremHost_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            base_path='/api/anycast/v1',
            resource_path='/accm/op_hosts/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def GetAnycastConfigList(
        ...
        host_id: Optional[StrictInt] = None,
        ophid: Optional[StrictStr] = None,
        is_configured: Optional[StrictBool] = None,
        tfilter: Optional[StrictStr] = None,
        torder_by: Optional[StrictStr] = None,
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
                                Tuple[Annotated[StrictFloat,
                                                Field(gt=0)],
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetAnycastConfigListResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def GetAnycastConfigList_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetAnycastConfigListResponse]:
        """Retrieve Multiple Anycast Configurations
    ...
    def _GetAnycastConfigList_serialize(
        ...
        if ophid is not None:
            ...
            _query_params.append(('ophid', ophid))

        if is_configured is not None:

            _query_params.append(('is_configured', is_configured))
    ...
    def _GetOnpremConfig_serialize(
        ...
        # process the path parameters
        if ophid is not None:
            _path_params['ophid'] = self.api_client.path_param_value(
                'ophid', ophid)
        if version is not None:
            _path_params['version'] = self.api_client.path_param_value(
                'version', version)
        # process the query parameters
        ...
        return self.api_client.param_serialize(
            method='GET',
            base_path='/api/anycast/v1',
            resource_path='/accm/oph_configs/{ophid}/{version}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _GetOnpremConfig2_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            base_path='/api/anycast/v1',
            resource_path='/onprem_config/{ophid}/{version}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def GetOnpremHost_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OnpremHostResponse]:
        """Retrieve On-Prem Host
    ...
    def GetStatus_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ServiceStatusUpdateRequest]:
        """Retrieve Configuration Status
    ...
    def _GetStatus_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            base_path='/api/anycast/v1',
            resource_path='/accm/oph_config_statuses/{ophid}/latest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _GetStatus2_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            base_path='/api/anycast/v1',
            resource_path='/onprem_config_statuses/{ophid}/latest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _ListAnycastConfigsWithRuntimeStatus_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            base_path='/api/anycast/v1',
            resource_path='/accm/ac_runtime_statuses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _ReadAnycastConfigWithRuntimeStatus_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            base_path='/api/anycast/v1',
            resource_path='/accm/ac_runtime_statuses/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def UpdateOnpremHost(
        ...
        :param id: Numeric host identifier (required)
        :type id: int
        :param body: (required)
        :type body: OnpremHost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
