...
class TestServiceStatusUpdateRequest(unittest.TestCase):
    """ServiceStatusUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceStatusUpdateRequest:
        """Test ServiceStatusUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceStatusUpdateRequest`
        """
        model = ServiceStatusUpdateRequest()
        if include_optional:
    ...
    def testServiceStatusUpdateRequest(self):
        """Test ServiceStatusUpdateRequest"""
