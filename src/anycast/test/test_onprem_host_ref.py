...
class TestOnpremHostRef(unittest.TestCase):
    """OnpremHostRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnpremHostRef:
        """Test OnpremHostRef
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnpremHostRef`
        """
        model = OnpremHostRef()
        if include_optional:
            return OnpremHostRef(
                id = 56,
