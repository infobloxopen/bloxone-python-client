...
class TestAnycastVersion(unittest.TestCase):
    """AnycastVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnycastVersion:
        """Test AnycastVersion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnycastVersion`
        """
        model = AnycastVersion()
        if include_optional:
