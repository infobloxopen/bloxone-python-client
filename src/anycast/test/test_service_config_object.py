...
class TestServiceConfigObject(unittest.TestCase):
    """ServiceConfigObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceConfigObject:
        """Test ServiceConfigObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceConfigObject`
        """
        model = ServiceConfigObject()
        if include_optional:
    ...
    def testServiceConfigObject(self):
        """Test ServiceConfigObject"""
