...
class TestGetAnycastConfigListResponse(unittest.TestCase):
    """GetAnycastConfigListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAnycastConfigListResponse:
        """Test GetAnycastConfigListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAnycastConfigListResponse`
        """
        model = GetAnycastConfigListResponse()
        if include_optional:
            return GetAnycastConfigListResponse(
                results = [
                    anycast.models.proto_anycast_config.protoAnycastConfig(
                        account_id = 56, 
                        anycast_ip_address = '', 
    ...
    def testGetAnycastConfigListResponse(self):
        """Test GetAnycastConfigListResponse"""
