...
class TestOnpremHostResponse(unittest.TestCase):
    """OnpremHostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnpremHostResponse:
        """Test OnpremHostResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnpremHostResponse`
        """
        model = OnpremHostResponse()
        if include_optional:
            return OnpremHostResponse(
                results = anycast.models.struct_onprem_host;_represents_one_anycast_enabled_on_prem_host.Struct OnpremHost; represents one anycast-enabled on-prem host(
                    anycast_config_refs = [
    ...
    def testOnpremHostResponse(self):
        """Test OnpremHostResponse"""
