...
class TestAnycastConfig(unittest.TestCase):
    """AnycastConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnycastConfig:
        """Test AnycastConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnycastConfig`
        """
        model = AnycastConfig()
        if include_optional:
