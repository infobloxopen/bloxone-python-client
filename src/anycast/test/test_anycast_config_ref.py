...
class TestAnycastConfigRef(unittest.TestCase):
    """AnycastConfigRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnycastConfigRef:
        """Test AnycastConfigRef
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnycastConfigRef`
        """
        model = AnycastConfigRef()
        if include_optional:
            return AnycastConfigRef(
                anycast_config_name = '',
