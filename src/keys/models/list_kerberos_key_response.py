...
class ListKerberosKeyResponse(BaseModel):
    """
    The response format to retrieve __KerberosKey__ resources extracted from the uploaded keytab file.
    """ # noqa: E501
    results: Optional[List[KerberosKey]] = Field(
        default=None, description="The list of KerberosKey objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [KerberosKey.from_dict(_item) for _item in obj["results"]]
