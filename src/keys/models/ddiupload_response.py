...
class DdiuploadResponse(BaseModel):
    """
    The response format for uploading content.
    """

  # noqa: E501
    kerberos_keys: Optional[KerberosKeys] = None
    ...
    __properties: ClassVar[List[str]] = ["kerberos_keys", "warning"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "kerberos_keys":
            KerberosKeys.from_dict(obj["kerberos_keys"])
