...
class ListTSIGKeyResponse(BaseModel):
    """
    The response format to retrieve __TSIGKey__ objects.
    """ # noqa: E501
    results: Optional[List[TSIGKey]] = Field(
        default=None, description="The list of TSIGKey objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [TSIGKey.from_dict(_item) for _item in obj["results"]]
