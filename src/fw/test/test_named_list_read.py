...
class TestNamedListRead(unittest.TestCase):
    """NamedListRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamedListRead:
        """Test NamedListRead
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedListRead`
        """
        model = NamedListRead()
        if include_optional:
            return NamedListRead(
