...
class TestNamedListUpdateResponse(unittest.TestCase):
    """NamedListUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamedListUpdateResponse:
        """Test NamedListUpdateResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedListUpdateResponse`
        """
        model = NamedListUpdateResponse()
        if include_optional:
    ...
    def testNamedListUpdateResponse(self):
        """Test NamedListUpdateResponse"""
