...
class TestAccessCode(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccessCode:
        """Test AccessCode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessCode`
        """
        model = AccessCode()
        if include_optional:
            return AccessCode(
