...
class TestNamedListReadResponse(unittest.TestCase):
    """NamedListReadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamedListReadResponse:
        """Test NamedListReadResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamedListReadResponse`
        """
        model = NamedListReadResponse()
        if include_optional:
    ...
    def testNamedListReadResponse(self):
        """Test NamedListReadResponse"""
