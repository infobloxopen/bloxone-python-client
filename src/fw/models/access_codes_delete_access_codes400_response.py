...
class AccessCodesDeleteAccessCodes400Response(BaseModel):
    """
    AccessCodesDeleteAccessCodes400Response
    """

  # noqa: E501
    error: Optional[AccessCodesDeleteAccessCodes400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            AccessCodesDeleteAccessCodes400ResponseError.from_dict(
