...
class CategoryFiltersCreateCategoryFilter409Response(BaseModel):
    """
    CategoryFiltersCreateCategoryFilter409Response
    """ # noqa: E501
    error: Optional[CategoryFiltersCreateCategoryFilter409ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            CategoryFiltersCreateCategoryFilter409ResponseError.from_dict(
