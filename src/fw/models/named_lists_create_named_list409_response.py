...
class NamedListsCreateNamedList409Response(BaseModel):
    """
    NamedListsCreateNamedList409Response
    """

  # noqa: E501
    error: Optional[NamedListsCreateNamedList409ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NamedListsCreateNamedList409ResponseError.from_dict(obj["error"])
