...
class NamedListReadMultiResponse(BaseModel):
    """
    The Named List list response.
    """

  # noqa: E501
    results: Optional[List[NamedListRead]] = Field(
        default=None, description="The list of Named List objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [NamedListRead.from_dict(_item) for _item in obj["results"]]
