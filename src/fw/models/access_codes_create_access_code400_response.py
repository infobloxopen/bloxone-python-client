...
class AccessCodesCreateAccessCode400Response(BaseModel):
    """
    AccessCodesCreateAccessCode400Response
    """

  # noqa: E501
    error: Optional[AccessCodesCreateAccessCode400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            AccessCodesCreateAccessCode400ResponseError.from_dict(obj["error"])
