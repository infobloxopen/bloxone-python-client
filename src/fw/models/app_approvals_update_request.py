...
class AppApprovalsUpdateRequest(BaseModel):
    """
  ...
  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = [
        "fields", "inserted_approvals", "removed_approvals"
    ]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in inserted_approvals (list)
        _items = []
        if self.inserted_approvals:
            for _item in self.inserted_approvals:
                if _item:
                    _items.append(_item.to_dict())
            _dict['inserted_approvals'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in removed_approvals (list)
        _items = []
        if self.removed_approvals:
            for _item in self.removed_approvals:
                if _item:
                    _items.append(_item.to_dict())
            _dict['removed_approvals'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inserted_approvals": [
                AppApproval.from_dict(_item)
                for _item in obj["inserted_approvals"]
            ] if obj.get("inserted_approvals") is not None else None,
            "removed_approvals": [
                AppApprovalRemovalRequest.from_dict(_item)
                for _item in obj["removed_approvals"]
            ] if obj.get("removed_approvals") is not None else None
        })
