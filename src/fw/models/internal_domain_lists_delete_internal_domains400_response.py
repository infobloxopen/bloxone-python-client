...
class InternalDomainListsDeleteInternalDomains400Response(BaseModel):
    """
    InternalDomainListsDeleteInternalDomains400Response
    """ # noqa: E501
    error: Optional[
        InternalDomainListsDeleteInternalDomains400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            InternalDomainListsDeleteInternalDomains400ResponseError.from_dict(
