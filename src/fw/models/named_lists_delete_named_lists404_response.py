...
class NamedListsDeleteNamedLists404Response(BaseModel):
    """
    NamedListsDeleteNamedLists404Response
    """

  # noqa: E501
    error: Optional[NamedListsDeleteNamedLists404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NamedListsDeleteNamedLists404ResponseError.from_dict(obj["error"])
