...
class AccessCodesCreateAccessCode409Response(BaseModel):
    """
    AccessCodesCreateAccessCode409Response
    """

  # noqa: E501
    error: Optional[AccessCodesCreateAccessCode409ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            AccessCodesCreateAccessCode409ResponseError.from_dict(obj["error"])
