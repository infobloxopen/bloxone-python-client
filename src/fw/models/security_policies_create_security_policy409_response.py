...
class SecurityPoliciesCreateSecurityPolicy409Response(BaseModel):
    """
    SecurityPoliciesCreateSecurityPolicy409Response
    """ # noqa: E501
    error: Optional[
        SecurityPoliciesCreateSecurityPolicy409ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            SecurityPoliciesCreateSecurityPolicy409ResponseError.from_dict(
