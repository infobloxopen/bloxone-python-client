...
class NetworkList(BaseModel):
    ...
    id: Optional[StrictInt] = Field(
        default=None, description="The Network List object identifier.")
    ...
    name: Optional[StrictStr] = Field(
        default=None, description="The name of the network list.")
    ...
    __properties: ClassVar[List[str]] = [
        "created_time", "description", "id", "items", "name", "policy_id",
        "updated_time"
    ]
