...
class NamedListsUpdateNamedListPartial405Response(BaseModel):
    """
    NamedListsUpdateNamedListPartial405Response
    """

  # noqa: E501
    error: Optional[NamedListsUpdateNamedListPartial405ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NamedListsUpdateNamedListPartial405ResponseError.from_dict(
