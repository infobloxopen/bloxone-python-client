...
class SecurityPolicyRuleMultiResponse(BaseModel):
    """
    The Security Policy Rule list response.
    """

  # noqa: E501
    results: Optional[List[SecurityPolicyRule]] = Field(
        default=None, description="The list of Security Policy Rule objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [SecurityPolicyRule.from_dict(_item) for _item in obj["results"]]
