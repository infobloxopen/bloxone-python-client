...
class ListPoPRegionsResponse(BaseModel):
    """
    ListPoPRegionsResponse
    """

  # noqa: E501
    results: Optional[List[PoPRegion]] = None
    total_result_count: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["results", "total_result_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [PoPRegion.from_dict(_item) for _item in obj["results"]]
            if obj.get("results") is not None else None,
            "total_result_count":
            obj.get("total_result_count")
        })
