...
class CategoryFilterMultiResponse(BaseModel):
    """
    The Category Filter list response.
    """

  # noqa: E501
    results: Optional[List[CategoryFilter]] = Field(
        default=None, description="The list of Category Filter objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [CategoryFilter.from_dict(_item) for _item in obj["results"]]
