...
class CategoryFiltersCreateCategoryFilter400Response(BaseModel):
    """
    CategoryFiltersCreateCategoryFilter400Response
    """ # noqa: E501
    error: Optional[CategoryFiltersCreateCategoryFilter400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            CategoryFiltersCreateCategoryFilter400ResponseError.from_dict(
