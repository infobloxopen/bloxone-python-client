...
class NetworkListsDeleteNetworkLists404Response(BaseModel):
    """
    NetworkListsDeleteNetworkLists404Response
    """

  # noqa: E501
    error: Optional[NetworkListsDeleteNetworkLists404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NetworkListsDeleteNetworkLists404ResponseError.from_dict(
