...
class SecurityPoliciesCreateSecurityPolicy400Response(BaseModel):
    """
    SecurityPoliciesCreateSecurityPolicy400Response
    """ # noqa: E501
    error: Optional[
        SecurityPoliciesCreateSecurityPolicy400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            SecurityPoliciesCreateSecurityPolicy400ResponseError.from_dict(
