...
class ThreatFeedMultiResponse(BaseModel):
    """
    The Threat Feed list response.
    """

  # noqa: E501
    results: Optional[List[ThreatFeed]] = Field(
        default=None, description="The list of Threat Feed objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [ThreatFeed.from_dict(_item) for _item in obj["results"]]
