...
class ContentCategory(BaseModel):
    ...
    category_code: Optional[StrictInt] = Field(
        default=None, description="The category code.")
    category_name: Optional[StrictStr] = Field(
        default=None, description="The name of the category.")
    functional_group: Optional[StrictStr] = Field(
        default=None, description="The functional group name of the category.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category_code":
            obj.get("category_code"),
            "category_name":
            obj.get("category_name"),
            "functional_group":
