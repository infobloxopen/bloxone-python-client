...
class InternalDomainsMultiResponse(BaseModel):
    """
    The Internal domains list response.
    """

  # noqa: E501
    results: Optional[List[InternalDomains]] = Field(
        default=None, description="The list of Internal Domains objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [InternalDomains.from_dict(_item) for _item in obj["results"]]
