...
class NetworkListsCreateNetworkList409Response(BaseModel):
    """
    NetworkListsCreateNetworkList409Response
    """

  # noqa: E501
    error: Optional[NetworkListsCreateNetworkList409ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NetworkListsCreateNetworkList409ResponseError.from_dict(
