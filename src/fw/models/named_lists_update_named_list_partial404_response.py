...
class NamedListsUpdateNamedListPartial404Response(BaseModel):
    """
    NamedListsUpdateNamedListPartial404Response
    """

  # noqa: E501
    error: Optional[NamedListsUpdateNamedListPartial404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NamedListsUpdateNamedListPartial404ResponseError.from_dict(
