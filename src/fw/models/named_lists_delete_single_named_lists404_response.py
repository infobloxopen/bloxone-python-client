...
class NamedListsDeleteSingleNamedLists404Response(BaseModel):
    """
    NamedListsDeleteSingleNamedLists404Response
    """

  # noqa: E501
    error: Optional[NamedListsDeleteSingleNamedLists404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NamedListsDeleteSingleNamedLists404ResponseError.from_dict(
