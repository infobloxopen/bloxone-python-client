...
class AccessCodesDeleteSingleAccessCodes400Response(BaseModel):
    """
    AccessCodesDeleteSingleAccessCodes400Response
    """

  # noqa: E501
    error: Optional[AccessCodesDeleteSingleAccessCodes400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            AccessCodesDeleteSingleAccessCodes400ResponseError.from_dict(
