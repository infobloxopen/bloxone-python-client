...
class InternalDomainListsUpdateInternalDomains400Response(BaseModel):
    """
    InternalDomainListsUpdateInternalDomains400Response
    """ # noqa: E501
    error: Optional[
        InternalDomainListsUpdateInternalDomains400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            InternalDomainListsUpdateInternalDomains400ResponseError.from_dict(
