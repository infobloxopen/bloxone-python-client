...
class SecurityPoliciesReadSecurityPolicy404Response(BaseModel):
    """
    SecurityPoliciesReadSecurityPolicy404Response
    """

  # noqa: E501
    error: Optional[SecurityPoliciesReadSecurityPolicy404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            SecurityPoliciesReadSecurityPolicy404ResponseError.from_dict(
