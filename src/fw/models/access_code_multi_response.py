...
class AccessCodeMultiResponse(BaseModel):
    """
    AccessCodeMultiResponse
    """

  # noqa: E501
    results: Optional[List[AccessCode]] = Field(
        default=None, description="The list of Bypass Code objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [AccessCode.from_dict(_item) for _item in obj["results"]]
