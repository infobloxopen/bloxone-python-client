...
class CategoryFiltersReadCategoryFilter404Response(BaseModel):
    """
    CategoryFiltersReadCategoryFilter404Response
    """

  # noqa: E501
    error: Optional[CategoryFiltersReadCategoryFilter404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            CategoryFiltersReadCategoryFilter404ResponseError.from_dict(
