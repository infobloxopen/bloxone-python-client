...
class NetworkListMultiResponse(BaseModel):
    """
    The Network List list response.
    """

  # noqa: E501
    results: Optional[List[NetworkList]] = Field(
        default=None, description="The list of Network List objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [NetworkList.from_dict(_item) for _item in obj["results"]]
