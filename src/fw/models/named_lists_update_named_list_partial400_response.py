...
class NamedListsUpdateNamedListPartial400Response(BaseModel):
    """
    NamedListsUpdateNamedListPartial400Response
    """

  # noqa: E501
    error: Optional[NamedListsUpdateNamedListPartial400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NamedListsUpdateNamedListPartial400ResponseError.from_dict(
