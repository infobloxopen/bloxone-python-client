...
class PopRegionsReadPoPRegion404Response(BaseModel):
    """
    PopRegionsReadPoPRegion404Response
    """

  # noqa: E501
    error: Optional[PopRegionsReadPoPRegion404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            PopRegionsReadPoPRegion404ResponseError.from_dict(obj["error"])
