...
class ContentCategoryMultiResponse(BaseModel):
    """
    The Content Category list response.
    """

  # noqa: E501
    results: Optional[List[ContentCategory]] = Field(
        default=None, description="The list of Content Category objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [ContentCategory.from_dict(_item) for _item in obj["results"]]
