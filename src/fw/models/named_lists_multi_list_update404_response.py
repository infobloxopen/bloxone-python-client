...
class NamedListsMultiListUpdate404Response(BaseModel):
    """
    NamedListsMultiListUpdate404Response
    """

  # noqa: E501
    error: Optional[NamedListsMultiListUpdate404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NamedListsMultiListUpdate404ResponseError.from_dict(obj["error"])
