...
class SecurityPolicyMultiResponse(BaseModel):
    """
    The Security Policy list response.
    """

  # noqa: E501
    results: Optional[List[SecurityPolicy]] = Field(
        default=None, description="The list of Security Policy objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [SecurityPolicy.from_dict(_item) for _item in obj["results"]]
