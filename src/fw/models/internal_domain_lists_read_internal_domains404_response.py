...
class InternalDomainListsReadInternalDomains404Response(BaseModel):
    """
    InternalDomainListsReadInternalDomains404Response
    """ # noqa: E501
    error: Optional[
        InternalDomainListsReadInternalDomains404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            InternalDomainListsReadInternalDomains404ResponseError.from_dict(
