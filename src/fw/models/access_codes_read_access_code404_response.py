...
class AccessCodesReadAccessCode404Response(BaseModel):
    """
    AccessCodesReadAccessCode404Response
    """

  # noqa: E501
    error: Optional[AccessCodesReadAccessCode404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            AccessCodesReadAccessCode404ResponseError.from_dict(obj["error"])
