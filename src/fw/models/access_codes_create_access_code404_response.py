...
class AccessCodesCreateAccessCode404Response(BaseModel):
    """
    AccessCodesCreateAccessCode404Response
    """

  # noqa: E501
    error: Optional[AccessCodesCreateAccessCode404ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            AccessCodesCreateAccessCode404ResponseError.from_dict(obj["error"])
