...
class NetworkListsDeleteNetworkLists400Response(BaseModel):
    """
    NetworkListsDeleteNetworkLists400Response
    """

  # noqa: E501
    error: Optional[NetworkListsDeleteNetworkLists400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NetworkListsDeleteNetworkLists400ResponseError.from_dict(
