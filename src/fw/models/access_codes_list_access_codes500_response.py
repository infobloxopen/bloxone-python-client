...
class AccessCodesListAccessCodes500Response(BaseModel):
    """
    AccessCodesListAccessCodes500Response
    """

  # noqa: E501
    error: Optional[AccessCodesListAccessCodes500ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            AccessCodesListAccessCodes500ResponseError.from_dict(obj["error"])
