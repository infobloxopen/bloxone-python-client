...
class ApplicationFilterMultiResponse(BaseModel):
    """
    The Application Filter list response.
    """

  # noqa: E501
    results: Optional[List[ApplicationFilter]] = Field(
        default=None, description="The list of Application Filter objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [ApplicationFilter.from_dict(_item) for _item in obj["results"]]
