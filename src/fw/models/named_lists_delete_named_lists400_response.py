...
class NamedListsDeleteNamedLists400Response(BaseModel):
    """
    NamedListsDeleteNamedLists400Response
    """

  # noqa: E501
    error: Optional[NamedListsDeleteNamedLists400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NamedListsDeleteNamedLists400ResponseError.from_dict(obj["error"])
