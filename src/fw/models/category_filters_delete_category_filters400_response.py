...
class CategoryFiltersDeleteCategoryFilters400Response(BaseModel):
    """
    CategoryFiltersDeleteCategoryFilters400Response
    """ # noqa: E501
    error: Optional[
        CategoryFiltersDeleteCategoryFilters400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            CategoryFiltersDeleteCategoryFilters400ResponseError.from_dict(
