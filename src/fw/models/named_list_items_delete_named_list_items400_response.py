...
class NamedListItemsDeleteNamedListItems400Response(BaseModel):
    """
    NamedListItemsDeleteNamedListItems400Response
    """

  # noqa: E501
    error: Optional[NamedListItemsDeleteNamedListItems400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            NamedListItemsDeleteNamedListItems400ResponseError.from_dict(
