...
class CategoryFiltersApi:
    ...
    def CreateCategoryFilter(
        ...
        :param body: The Category Filter object. (required)
        :type body: CategoryFilter
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CategoryFilterCreateResponse",
            '400': "CategoryFiltersCreateCategoryFilter400Response",
            '409': "CategoryFiltersCreateCategoryFilter409Response",
    ...
    def _CreateCategoryFilter_serialize(
        ...
        return self.api_client.param_serialize(
            ...
            resource_path='/category_filters',
    ...
    def DeleteCategoryFilters(
        ...
        :param body: (required)
        :type body: CategoryFiltersDeleteRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': None,
            '400': "CategoryFiltersDeleteCategoryFilters400Response",
            '500': "AccessCodesListAccessCodes500Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
    ...
    def DeleteSingleCategoryFilters(
        ...
        id: Annotated[
            StrictInt,
            Field(description="The Category Filter object identifier.")],
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
                                Tuple[Annotated[StrictFloat,
                                                Field(gt=0)],
        ...
        :param id: The Category Filter object identifier. (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _DeleteSingleCategoryFilters_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            base_path='/api/atcfw/v1',
            resource_path='/category_filters/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def ListCategoryFilters(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CategoryFilterMultiResponse",
            '500': "AccessCodesListAccessCodes500Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
    ...
    def ListCategoryFilters_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CategoryFilterMultiResponse]:
        """List Category Filters.
    ...
    def ReadCategoryFilter(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CategoryFilterReadResponse",
            '404': "CategoryFiltersReadCategoryFilter404Response",
            '500': "AccessCodesListAccessCodes500Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
    ...
    def ReadCategoryFilter_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CategoryFilterReadResponse]:
        """Read Category Filter.
    ...
    def UpdateCategoryFilter(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CategoryFilterUpdateResponse",
            '400': "CategoryFiltersCreateCategoryFilter400Response",
            '404': "CategoryFiltersReadCategoryFilter404Response",
            '409': "CategoryFiltersCreateCategoryFilter409Response",
            '500': "AccessCodesListAccessCodes500Response",
    ...
    def UpdateCategoryFilter_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CategoryFilterUpdateResponse]:
        """Update Category Filter.
