...
class NamedListItemsApi:
    ...
    def delete_named_list_items(
        ...
        :type id: int
        :param body: (required)
        :type body: NamedListItemsDeleteRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': None,
            '400': "NamedListItemsDeleteNamedListItems400Response",
    ...
    def _delete_named_list_items_serialize(
        ...
        return self.api_client.param_serialize(
            ...
            resource_path='/named_lists/{id}/items',
    ...
    def insert_or_replace_named_list_items(
        ...
        body: Annotated[
            ...
            Field(description="NamedListItemsInsertOrUpdate object")],
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
                                Tuple[Annotated[StrictFloat,
                                                Field(gt=0)],
        ...
        :param id: The Named List object identifier. (required)
        :type id: int
        :param body: NamedListItemsInsertOrUpdate object (required)
        :type body: NamedListItemsInsertOrUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "NamedListItemsInsertOrUpdateResponse",
            '400': "NamedListItemsInsertOrReplaceNamedListItems400Response",
            '404': "NamedListsMultiListUpdate404Response",
            '500': "AccessCodesListAccessCodes500Response",
        }
        response_data = self.api_client.call_api(
    ...
    def insert_or_replace_named_list_items_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NamedListItemsInsertOrUpdateResponse]:
        """Insert Named List Items.
    ...
    def named_list_items_partial_update(
        ...
        id: Annotated[StrictInt,
                      Field(description="The Named List object identifier.")],
        body: Annotated[NamedListItemsPartialUpdate,
                        Field(
        ...
        :param id: The Named List object identifier. (required)
        :type id: int
        :param body: NamedListItemsPartialUpdate object (required)
        :type body: NamedListItemsPartialUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "object",
            '400': "NamedListItemsNamedListItemsPartialUpdate400Response",
            '404': "NamedListsMultiListUpdate404Response",
            '500': "AccessCodesListAccessCodes500Response",
        }
        response_data = self.api_client.call_api(
