...
class NamedListsApi:
    ...
    def create_named_list(
        ...
        :param body: The Named List object. (required)
        :type body: NamedList
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '400': "CategoryFiltersCreateCategoryFilter400Response",
            '409': "NamedListsCreateNamedList409Response",
    ...
    def create_named_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NamedListCreateResponse]:
        """Create Named List.
    ...
    def delete_named_lists(
        ...
        :param body: (required)
        :type body: NamedListsDeleteRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': None,
            '400': "NamedListsDeleteNamedLists400Response",
            '404': "NamedListsDeleteNamedLists404Response",
            '500': "AccessCodesListAccessCodes500Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
    ...
    def delete_single_named_lists(
        ...
        :param id: The Named List object identifiers. (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '404': "NamedListsDeleteSingleNamedLists404Response",
            '500': "AccessCodesListAccessCodes500Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
    ...
    def list_named_lists_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NamedListReadMultiResponse]:
        """List Named Lists.
    ...
    def list_named_lists_csv_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NamedListCSVListResponse]:
        """List Named Lists in CSV format.
    ...
    def _list_named_lists_csv_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            base_path='/api/atcfw/v1',
            resource_path='/named_lists_download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def multi_list_update(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '404': "NamedListsMultiListUpdate404Response",
            '500': "AccessCodesListAccessCodes500Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
    ...
    def read_named_list(
        ...
        :param id: The Named List identifier. (required)
        :type id: int
        :param fields:   A collection of response resources can be transformed by specifying a set of JSON tags to be returned. For a “flat” resource, the tag name is straightforward. If field selection is allowed on non-flat hierarchical resources, the service should implement a qualified naming scheme such as dot-qualification to reference data down the hierarchy. If a resource does not have the specified tag, the tag does not appear in the output resource.  Specify this parameter as a comma-separated list of JSON tag names.        
        :type fields: str
        :param offset:   The integer index (zero-origin) of the offset into a collection of resources. If omitted or null the value is assumed to be '0'.         
        ...
        :param page_token:   The service-defined string used to identify a page of resources. A null value indicates the first page.         
        :type page_token: str
        :param name: The name of the named list. Can be used in pair with 'type' (both fields are mandatory) to request the object by their name. This aproach available only if the field 'id' is empty (==0).
        :type name: str
        :param type: The type of the named list. See 'NamedList' for more details.
        :type type: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def read_named_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NamedListReadResponse]:
        """Read Named List.
    ...
    def update_named_list(
        ...
        :param id: The Named List object identifier. (required)
        :type id: int
        :param body: The Named List object. (required)
        :type body: NamedList
        :param _request_timeout: timeout setting for this request. If one
    ...
    def update_named_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NamedListUpdateResponse]:
        """Update Named List.
    ...
    def update_named_list_partial(
        ...
        id: Annotated[StrictInt,
                      Field(description="The Named List object identifier.")],
        body: Annotated[ListSeverityLevels,
                        Field(description="The Named List object.")],
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
                                Tuple[Annotated[StrictFloat,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "NamedListUpdateResponse",
            '400': "NamedListsUpdateNamedListPartial400Response",
            '404': "NamedListsUpdateNamedListPartial404Response",
            '405': "NamedListsUpdateNamedListPartial405Response",
            '500': "AccessCodesListAccessCodes500Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
