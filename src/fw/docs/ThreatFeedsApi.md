...
with ApiClient(config) as api_client:
    ...
    try:
        # List Threat Feeds.
        api_response = api_instance.list_threat_feeds()
        pprint("The response of ThreatFeedsApi->list_threat_feeds:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling ThreatFeedsApi->list_threat_feeds: %s\n" % e)
```
