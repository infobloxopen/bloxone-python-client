...
class InfraServicesListDfpServices500Response(BaseModel):
    """
    InfraServicesListDfpServices500Response
    """

  # noqa: E501
    error: Optional[InfraServicesListDfpServices500ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            InfraServicesListDfpServices500ResponseError.from_dict(
