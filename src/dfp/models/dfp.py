...
class Dfp(BaseModel):
  ...
  # noqa: E501
    ...
    net_addr_policy_ids: Optional[List[NetAddrPolicyAssignment]] = Field(
        default=None,
        description="List of network-address-scoped security policy assignments"
    )
    ophid: Optional[StrictStr] = Field(
        default=None, description="The On-Prem Host identifier.")
    ...
    resolvers_all: Optional[List[Resolver]] = None
    ...
    __properties: ClassVar[List[str]] = [
        "created_time", "elb_ip_list", "forwarding_policy", "host", "id",
        "internal_domain_lists", "name", "net_addr_policy_ids", "ophid",
        "policy_id", "pop_region_id", "resolvers_all", "service_id",
        "service_name", "site_id", "updated_time"
    ]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.host:
            ...
            _dict['host'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in net_addr_policy_ids (list)
        _items = []
        if self.net_addr_policy_ids:
            for _item in self.net_addr_policy_ids:
                if _item:
                    _items.append(_item.to_dict())
            _dict['net_addr_policy_ids'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            obj.get("name"),
            "net_addr_policy_ids": [
                NetAddrPolicyAssignment.from_dict(_item)
                for _item in obj["net_addr_policy_ids"]
            ] if obj.get("net_addr_policy_ids") is not None else None,
            "ophid":
            obj.get("ophid"),
            "policy_id":
            obj.get("policy_id"),
