...
class Resolver(BaseModel):
  ...
  # noqa: E501
    address: Optional[StrictStr] = Field(
        default=None, description="address that can be used as resolver")
