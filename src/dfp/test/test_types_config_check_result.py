...
class TestTypesConfigCheckResult(unittest.TestCase):
    """TypesConfigCheckResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypesConfigCheckResult:
        """Test TypesConfigCheckResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypesConfigCheckResult`
        """
        model = TypesConfigCheckResult()
        if include_optional:
            return TypesConfigCheckResult(
                additional_info = '',
                config_check_type = '',
                resource_uri = '',
                result_code = ''
    ...
    def testTypesConfigCheckResult(self):
        """Test TypesConfigCheckResult"""
