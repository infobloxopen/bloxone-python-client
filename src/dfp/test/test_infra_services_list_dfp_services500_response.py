...
class TestInfraServicesListDfpServices500Response(unittest.TestCase):
    """InfraServicesListDfpServices500Response unit test stubs"""
    ...
    def make_instance(
            self, include_optional) -> InfraServicesListDfpServices500Response:
        """Test InfraServicesListDfpServices500Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfraServicesListDfpServices500Response`
        """
        model = InfraServicesListDfpServices500Response()
        if include_optional:
            return InfraServicesListDfpServices500Response(
                error = dfp.models.infra_services_list_dfp_services_500_response_error.infra_servicesListDfpServices_500_response_error(
                    code = 'INTERNAL', 
    ...
    def testInfraServicesListDfpServices500Response(self):
        """Test InfraServicesListDfpServices500Response"""
