...
class TestTypesConfigCheckResponse(unittest.TestCase):
    """TypesConfigCheckResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypesConfigCheckResponse:
        """Test TypesConfigCheckResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypesConfigCheckResponse`
        """
        model = TypesConfigCheckResponse()
        if include_optional:
            return TypesConfigCheckResponse(
                results = [
                    dfp.models.types_config_check_result.typesConfigCheckResult(
                        additional_info = '', 
                        config_check_type = '', 
                        resource_uri = '', 
                        result_code = '', )
    ...
    def testTypesConfigCheckResponse(self):
        """Test TypesConfigCheckResponse"""
