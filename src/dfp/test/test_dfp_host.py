...
class TestDfpHost(unittest.TestCase):
    """DfpHost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DfpHost:
        """Test DfpHost
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DfpHost`
        """
        model = DfpHost()
        if include_optional:
            return DfpHost(
