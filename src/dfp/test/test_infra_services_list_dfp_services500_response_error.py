...
class TestInfraServicesListDfpServices500ResponseError(unittest.TestCase):
    """InfraServicesListDfpServices500ResponseError unit test stubs"""
    ...
    def make_instance(
            self,
            include_optional) -> InfraServicesListDfpServices500ResponseError:
        """Test InfraServicesListDfpServices500ResponseError
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfraServicesListDfpServices500ResponseError`
        """
        model = InfraServicesListDfpServices500ResponseError()
        if include_optional:
            return InfraServicesListDfpServices500ResponseError(
                code = 'INTERNAL',
    ...
    def testInfraServicesListDfpServices500ResponseError(self):
        """Test InfraServicesListDfpServices500ResponseError"""
