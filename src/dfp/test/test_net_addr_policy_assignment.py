...
class TestNetAddrPolicyAssignment(unittest.TestCase):
    """NetAddrPolicyAssignment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetAddrPolicyAssignment:
        """Test NetAddrPolicyAssignment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetAddrPolicyAssignment`
        """
        model = NetAddrPolicyAssignment()
        if include_optional:
            return NetAddrPolicyAssignment(
                addr_net = '',
                policy_id = 56
            )
        else:
    ...
    def testNetAddrPolicyAssignment(self):
        """Test NetAddrPolicyAssignment"""
