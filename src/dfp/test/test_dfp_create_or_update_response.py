...
class TestDfpCreateOrUpdateResponse(unittest.TestCase):
    """DfpCreateOrUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DfpCreateOrUpdateResponse:
        """Test DfpCreateOrUpdateResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DfpCreateOrUpdateResponse`
        """
        model = DfpCreateOrUpdateResponse()
        if include_optional:
    ...
    def testDfpCreateOrUpdateResponse(self):
        """Test DfpCreateOrUpdateResponse"""
