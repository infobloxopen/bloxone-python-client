...
class TestInfraServicesCreateOrUpdateDfpService400ResponseError(
        unittest.TestCase):
    """InfraServicesCreateOrUpdateDfpService400ResponseError unit test stubs"""
    ...
    def make_instance(
        ...
        """Test InfraServicesCreateOrUpdateDfpService400ResponseError
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InfraServicesCreateOrUpdateDfpService400ResponseError`
        """
        model = InfraServicesCreateOrUpdateDfpService400ResponseError()
        if include_optional:
            return InfraServicesCreateOrUpdateDfpService400ResponseError(
    ...
    def testInfraServicesCreateOrUpdateDfpService400ResponseError(self):
        """Test InfraServicesCreateOrUpdateDfpService400ResponseError"""
