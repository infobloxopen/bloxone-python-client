...
class TestNextAvailableIPResponse(unittest.TestCase):
    """NextAvailableIPResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NextAvailableIPResponse:
        """Test NextAvailableIPResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NextAvailableIPResponse`
        """
        model = NextAvailableIPResponse()
        if include_optional:
    ...
    def testNextAvailableIPResponse(self):
        """Test NextAvailableIPResponse"""
