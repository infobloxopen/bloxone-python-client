...
class TestCreateAddressBlockResponse(unittest.TestCase):
    """CreateAddressBlockResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAddressBlockResponse:
        """Test CreateAddressBlockResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAddressBlockResponse`
        """
        model = CreateAddressBlockResponse()
        if include_optional:
            return CreateAddressBlockResponse(
                result = ipam.models.address_block.AddressBlock(
                    address = '', 
    ...
    def testCreateAddressBlockResponse(self):
        """Test CreateAddressBlockResponse"""
