...
class TestUpdateGlobalResponse(unittest.TestCase):
    """UpdateGlobalResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateGlobalResponse:
        """Test UpdateGlobalResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateGlobalResponse`
        """
        model = UpdateGlobalResponse()
        if include_optional:
    ...
    def testUpdateGlobalResponse(self):
        """Test UpdateGlobalResponse"""
