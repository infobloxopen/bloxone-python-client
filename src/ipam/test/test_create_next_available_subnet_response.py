...
class TestCreateNextAvailableSubnetResponse(unittest.TestCase):
    """CreateNextAvailableSubnetResponse unit test stubs"""
    ...
    def make_instance(self,
                      include_optional) -> CreateNextAvailableSubnetResponse:
        """Test CreateNextAvailableSubnetResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNextAvailableSubnetResponse`
        """
        model = CreateNextAvailableSubnetResponse()
        if include_optional:
    ...
    def testCreateNextAvailableSubnetResponse(self):
        """Test CreateNextAvailableSubnetResponse"""
