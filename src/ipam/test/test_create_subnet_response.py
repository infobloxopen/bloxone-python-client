...
class TestCreateSubnetResponse(unittest.TestCase):
    """CreateSubnetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSubnetResponse:
        """Test CreateSubnetResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSubnetResponse`
        """
    ...
    def testCreateSubnetResponse(self):
        """Test CreateSubnetResponse"""
