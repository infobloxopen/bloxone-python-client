...
class TestHostAssociationsResponse(unittest.TestCase):
    """HostAssociationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HostAssociationsResponse:
        """Test HostAssociationsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HostAssociationsResponse`
        """
        model = HostAssociationsResponse()
        if include_optional:
            return HostAssociationsResponse(
                dhcp_pkt_stats = ipam.models.dhcp_packet_stats.DHCPPacketStats(
                    dhcp_pkt_received = '', 
                ...
                host = ipam.models.host.Host(
                    address = '', 
                    anycast_addresses = [
                        ''
                        ], 
                    associated_server = ipam.models.ipamsvc_host_associated_server.ipamsvcHostAssociatedServer(
                        id = '', 
                        name = '', ), 
                    comment = '', 
                    current_version = '', 
    ...
    def testHostAssociationsResponse(self):
        """Test HostAssociationsResponse"""
