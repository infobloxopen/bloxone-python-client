...
class TestNextAvailableSubnetResponse(unittest.TestCase):
    """NextAvailableSubnetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NextAvailableSubnetResponse:
        """Test NextAvailableSubnetResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NextAvailableSubnetResponse`
        """
        model = NextAvailableSubnetResponse()
        if include_optional:
    ...
    def testNextAvailableSubnetResponse(self):
        """Test NextAvailableSubnetResponse"""
