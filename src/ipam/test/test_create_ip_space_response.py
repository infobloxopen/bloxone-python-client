...
class TestCreateIPSpaceResponse(unittest.TestCase):
    """CreateIPSpaceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateIPSpaceResponse:
        """Test CreateIPSpaceResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateIPSpaceResponse`
        """
        model = CreateIPSpaceResponse()
        if include_optional:
    ...
    def testCreateIPSpaceResponse(self):
        """Test CreateIPSpaceResponse"""
