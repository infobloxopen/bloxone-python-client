...
class TestUpdateIpamHostResponse(unittest.TestCase):
    """UpdateIpamHostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateIpamHostResponse:
        """Test UpdateIpamHostResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateIpamHostResponse`
        """
        model = UpdateIpamHostResponse()
        if include_optional:
    ...
    def testUpdateIpamHostResponse(self):
        """Test UpdateIpamHostResponse"""
