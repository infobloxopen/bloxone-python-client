...
class TestListFixedAddressResponse(unittest.TestCase):
    """ListFixedAddressResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListFixedAddressResponse:
        """Test ListFixedAddressResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListFixedAddressResponse`
        """
        model = ListFixedAddressResponse()
        if include_optional:
            return ListFixedAddressResponse(
                results = [
                    ipam.models.fixed_address.FixedAddress(
    ...
    def testListFixedAddressResponse(self):
        """Test ListFixedAddressResponse"""
