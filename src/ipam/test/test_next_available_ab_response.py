...
class TestNextAvailableABResponse(unittest.TestCase):
    """NextAvailableABResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NextAvailableABResponse:
        """Test NextAvailableABResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NextAvailableABResponse`
        """
        model = NextAvailableABResponse()
        if include_optional:
    ...
    def testNextAvailableABResponse(self):
        """Test NextAvailableABResponse"""
