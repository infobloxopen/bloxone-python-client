...
class TestUpdateAddressBlockResponse(unittest.TestCase):
    """UpdateAddressBlockResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAddressBlockResponse:
        """Test UpdateAddressBlockResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAddressBlockResponse`
        """
        model = UpdateAddressBlockResponse()
        if include_optional:
    ...
    def testUpdateAddressBlockResponse(self):
        """Test UpdateAddressBlockResponse"""
