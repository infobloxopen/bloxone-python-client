...
class TestListIPSpaceResponse(unittest.TestCase):
    """ListIPSpaceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListIPSpaceResponse:
        """Test ListIPSpaceResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListIPSpaceResponse`
        """
        model = ListIPSpaceResponse()
        if include_optional:
            return ListIPSpaceResponse(
                results = [
                    ipam.models.ip_space.IPSpace(
    ...
    def testListIPSpaceResponse(self):
        """Test ListIPSpaceResponse"""
