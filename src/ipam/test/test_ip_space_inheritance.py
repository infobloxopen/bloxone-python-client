...
class TestIPSpaceInheritance(unittest.TestCase):
    """IPSpaceInheritance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPSpaceInheritance:
        """Test IPSpaceInheritance
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPSpaceInheritance`
        """
        model = IPSpaceInheritance()
        if include_optional:
            return IPSpaceInheritance(
    ...
    def testIPSpaceInheritance(self):
        """Test IPSpaceInheritance"""
