...
class TestUpdateIPSpaceResponse(unittest.TestCase):
    """UpdateIPSpaceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateIPSpaceResponse:
        """Test UpdateIPSpaceResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateIPSpaceResponse`
        """
        model = UpdateIPSpaceResponse()
        if include_optional:
            return UpdateIPSpaceResponse(
                result = ipam.models.ip_space.IPSpace(
    ...
    def testUpdateIPSpaceResponse(self):
        """Test UpdateIPSpaceResponse"""
