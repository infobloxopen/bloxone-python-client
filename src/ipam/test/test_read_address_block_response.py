...
class TestReadAddressBlockResponse(unittest.TestCase):
    """ReadAddressBlockResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadAddressBlockResponse:
        """Test ReadAddressBlockResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadAddressBlockResponse`
        """
        model = ReadAddressBlockResponse()
        if include_optional:
    ...
    def testReadAddressBlockResponse(self):
        """Test ReadAddressBlockResponse"""
