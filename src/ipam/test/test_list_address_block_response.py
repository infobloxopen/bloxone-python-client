...
class TestListAddressBlockResponse(unittest.TestCase):
    """ListAddressBlockResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAddressBlockResponse:
        """Test ListAddressBlockResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAddressBlockResponse`
        """
        model = ListAddressBlockResponse()
        if include_optional:
    ...
    def testListAddressBlockResponse(self):
        """Test ListAddressBlockResponse"""
