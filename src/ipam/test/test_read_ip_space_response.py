...
class TestReadIPSpaceResponse(unittest.TestCase):
    """ReadIPSpaceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadIPSpaceResponse:
        """Test ReadIPSpaceResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadIPSpaceResponse`
        """
        model = ReadIPSpaceResponse()
        if include_optional:
    ...
    def testReadIPSpaceResponse(self):
        """Test ReadIPSpaceResponse"""
