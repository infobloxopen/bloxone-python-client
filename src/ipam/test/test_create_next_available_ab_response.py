...
class TestCreateNextAvailableABResponse(unittest.TestCase):
    """CreateNextAvailableABResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNextAvailableABResponse:
        """Test CreateNextAvailableABResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNextAvailableABResponse`
        """
        model = CreateNextAvailableABResponse()
        if include_optional:
            return CreateNextAvailableABResponse(
                results = [
                    ipam.models.address_block.AddressBlock(
                        address = '', 
    ...
    def testCreateNextAvailableABResponse(self):
        """Test CreateNextAvailableABResponse"""
