...
class TestListSubnetResponse(unittest.TestCase):
    """ListSubnetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListSubnetResponse:
        """Test ListSubnetResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListSubnetResponse`
        """
        model = ListSubnetResponse()
        if include_optional:
    ...
    def testListSubnetResponse(self):
        """Test ListSubnetResponse"""
