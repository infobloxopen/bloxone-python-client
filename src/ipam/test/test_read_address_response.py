...
class TestReadAddressResponse(unittest.TestCase):
    """ReadAddressResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadAddressResponse:
        """Test ReadAddressResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadAddressResponse`
        """
        model = ReadAddressResponse()
        if include_optional:
            return ReadAddressResponse(
                result = ipam.models.address.Address(
                    address = '10.0.0.0', 
                    comment = '', 
    ...
    def testReadAddressResponse(self):
        """Test ReadAddressResponse"""
