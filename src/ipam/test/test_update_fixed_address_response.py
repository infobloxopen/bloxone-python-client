...
class TestUpdateFixedAddressResponse(unittest.TestCase):
    """UpdateFixedAddressResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateFixedAddressResponse:
        """Test UpdateFixedAddressResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFixedAddressResponse`
        """
        model = UpdateFixedAddressResponse()
        if include_optional:
    ...
    def testUpdateFixedAddressResponse(self):
        """Test UpdateFixedAddressResponse"""
