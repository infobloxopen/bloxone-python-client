...
class TestCreateFixedAddressResponse(unittest.TestCase):
    """CreateFixedAddressResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFixedAddressResponse:
        """Test CreateFixedAddressResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFixedAddressResponse`
        """
        model = CreateFixedAddressResponse()
        if include_optional:
    ...
    def testCreateFixedAddressResponse(self):
        """Test CreateFixedAddressResponse"""
