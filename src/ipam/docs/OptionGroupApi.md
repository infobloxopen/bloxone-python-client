...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of OptionGroupApi->create:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling OptionGroupApi->create: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("Exception when calling OptionGroupApi->delete: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of OptionGroupApi->list:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling OptionGroupApi->list: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of OptionGroupApi->read:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling OptionGroupApi->read: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of OptionGroupApi->update:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling OptionGroupApi->update: %s\n" % e)
```
