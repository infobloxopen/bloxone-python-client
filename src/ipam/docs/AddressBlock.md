...
**compartment_id** | **str** | The compartment associated with the object. If no compartment is associated with the object, the value defaults to empty. | [optional] 
...
**delegation** | **str** | The ID of the delegation associated with the address block. | [optional] [readonly] 
