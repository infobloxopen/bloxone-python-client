...
class ListOptionSpaceResponse(BaseModel):
    """
    The response format to retrieve __OptionSpace__ objects.
    """ # noqa: E501
    results: Optional[List[OptionSpace]] = Field(
        default=None, description="The list of OptionSpace objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [OptionSpace.from_dict(_item) for _item in obj["results"]]
