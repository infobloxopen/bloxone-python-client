...
class ListHardwareFilterResponse(BaseModel):
    """
    The response format to retrieve __HardwareFilter__ objects.
    """ # noqa: E501
    results: Optional[List[HardwareFilter]] = Field(
        default=None, description="The list of HardwareFilter objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [HardwareFilter.from_dict(_item) for _item in obj["results"]]
