...
class BulkCreateMacAddressItemResponse(BaseModel):
    """
    The response format to bulk create the __MacAddressItem__ objects.
    """ # noqa: E501
    results: Optional[List[MacAddressItem]] = Field(
        default=None, description="The created __MacAddressItem__ objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [MacAddressItem.from_dict(_item) for _item in obj["results"]]
