...
class ListIPSpaceResponse(BaseModel):
    """
    The response format to retrieve __IPSpace__ objects.
    """ # noqa: E501
    results: Optional[List[IPSpace]] = Field(
        default=None, description="The list of IPSpace objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [IPSpace.from_dict(_item) for _item in obj["results"]]
