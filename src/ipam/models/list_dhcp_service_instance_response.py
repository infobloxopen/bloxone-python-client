...
class ListDHCPServiceInstanceResponse(BaseModel):
    """
    The response format to retrieve DHCP __Service__ objects.
    """ # noqa: E501
    results: Optional[List[DHCPServiceInstance]] = Field(
        default=None, description="The list of DHCP Service objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [DHCPServiceInstance.from_dict(_item) for _item in obj["results"]]
