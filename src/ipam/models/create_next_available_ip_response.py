...
class CreateNextAvailableIPResponse(BaseModel):
    """
    The response format to allocate the next available IP address.
    """ # noqa: E501
    results: Optional[List[Address]] = Field(
        default=None, description="The list of allocated IP address objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [Address.from_dict(_item) for _item in obj["results"]]
