...
class ListOptionGroupResponse(BaseModel):
    """
    The response format to retrieve __OptionGroup__ objects.
    """ # noqa: E501
    results: Optional[List[OptionGroup]] = Field(
        default=None, description="A list of OptionGroup objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [OptionGroup.from_dict(_item) for _item in obj["results"]]
