...
class OptionFilterRuleList(BaseModel):
    """
    ...
    """ # noqa: E501
    match: Optional[StrictStr] = Field(
        default=None,
        description=
        "Indicates if this list should match if any or all rules match (_any_ or _all_)."
    )
    rules: Optional[List[OptionFilterRule]] = Field(
        default=None, description="The list of child rules.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["match", "rules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            obj.get("match"),
            "rules":
            [OptionFilterRule.from_dict(_item) for _item in obj["rules"]]
