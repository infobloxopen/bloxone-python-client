...
class ListOptionFilterResponse(BaseModel):
    """
    The response format to retrieve __OptionFilter__ objects.
    """ # noqa: E501
    results: Optional[List[OptionFilter]] = Field(
        default=None, description="The list of OptionFilter objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [OptionFilter.from_dict(_item) for _item in obj["results"]]
