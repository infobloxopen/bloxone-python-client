...
class ListRangeResponse(BaseModel):
    """
    The response format to retrieve __Range__ objects.
    """ # noqa: E501
    results: Optional[List[Range]] = Field(
        default=None, description="The list of Range objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [Range.from_dict(_item) for _item in obj["results"]]
