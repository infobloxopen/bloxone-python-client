...
class ListFilterResponse(BaseModel):
    """
    The response format to retrieve DHCP __Filter__ objects.
    """ # noqa: E501
    results: Optional[List[Filter]] = Field(
        default=None, description="The list of DHCP Filter objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [Filter.from_dict(_item) for _item in obj["results"]]
