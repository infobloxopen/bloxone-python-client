...
class BulkMacAddressItem(BaseModel):
    """
    A __BulkMacAddressItem__ object creates mac address items in bulk.
    """ # noqa: E501
    addresses: List[StrictStr] = Field(
        description="The addresses to match for the hardware filter.")
    hardware_filter_id: StrictStr = Field(
        description="The resource identifier.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["addresses", "hardware_filter_id"]
