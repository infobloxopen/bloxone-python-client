...
class BulkCopyIPSpaceResponse(BaseModel):
    """
    BulkCopyIPSpaceResponse
    """

  # noqa: E501
    errors: Optional[List[BulkCopyError]] = None
    results: Optional[List[CopyResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors":
            [BulkCopyError.from_dict(_item) for _item in obj["errors"]]
            if obj.get("errors") is not None else None,
            "results":
            [CopyResponse.from_dict(_item) for _item in obj["results"]]
