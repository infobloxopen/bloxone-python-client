...
class ListFixedAddressResponse(BaseModel):
    """
    The response format to retrieve __FixedAddress__ objects.
    """ # noqa: E501
    results: Optional[List[FixedAddress]] = Field(
        default=None, description="The list of FixedAddress objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [FixedAddress.from_dict(_item) for _item in obj["results"]]
