...
class ListDNSUsageResponse(BaseModel):
    """
    The response format to retrieve __DNSUsage__ objects.
    """ # noqa: E501
    results: Optional[List[DNSUsage]] = Field(
        default=None, description="The list of DNSUsage objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [DNSUsage.from_dict(_item) for _item in obj["results"]]
