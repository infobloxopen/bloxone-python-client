...
class DHCPGlobal(BaseModel):
    ...
    __properties: ClassVar[List[str]] = [
        "asm_config", "client_principal", "ddns_client_update",
        ...
        "dhcp_options", "dhcp_options_v6", "dhcp_threshold",
        "gss_tsig_fallback", "header_option_filename",
        "header_option_server_address", "header_option_server_name",
        "hostname_rewrite_char", "hostname_rewrite_enabled",
        "hostname_rewrite_regex", "id", "kerberos_kdc", "kerberos_keys",
        "kerberos_rekey_interval", "kerberos_retry_interval",
        "kerberos_tkey_lifetime", "kerberos_tkey_protocol", "prefer_option_12",
        "remove_suffix_option_81", "server_principal",
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of dhcp_threshold
        if self.dhcp_threshold:
            _dict['dhcp_threshold'] = self.dhcp_threshold.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dhcp_threshold":
            DHCPUtilizationThreshold.from_dict(obj["dhcp_threshold"])
            if obj.get("dhcp_threshold") is not None else None,
            "gss_tsig_fallback":
            ...
            "prefer_option_12":
            obj.get("prefer_option_12"),
            "remove_suffix_option_81":
            obj.get("remove_suffix_option_81"),
            "server_principal":
