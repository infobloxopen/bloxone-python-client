...
class CreateNextAvailableABResponse(BaseModel):
    """
    The Next Available Address Block object create response format.
    """ # noqa: E501
    results: Optional[List[AddressBlock]] = Field(
        default=None,
        description="The list of Next Available Address Block objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [AddressBlock.from_dict(_item) for _item in obj["results"]]
