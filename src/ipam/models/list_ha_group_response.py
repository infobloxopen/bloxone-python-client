...
class ListHAGroupResponse(BaseModel):
    """
    The response format to retrieve __HAGroup__ objects.
    """ # noqa: E501
    results: Optional[List[HAGroup]] = Field(
        default=None, description="The list of HAGroup objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [HAGroup.from_dict(_item) for _item in obj["results"]]
