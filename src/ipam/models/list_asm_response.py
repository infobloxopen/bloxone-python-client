...
class ListASMResponse(BaseModel):
    """
    The response format to retrieve __ASM__ objects.
    """ # noqa: E501
    results: Optional[List[ASM]] = Field(
        default=None, description="The list of ASM objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ASM.from_dict(_item) for _item in obj["results"]]
