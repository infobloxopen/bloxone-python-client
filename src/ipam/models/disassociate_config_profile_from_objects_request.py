...
class DisassociateConfigProfileFromObjectsRequest(BaseModel):
    """
    DisassociateConfigProfileToObjects disassociates an object to config profiles.
    """ # noqa: E501
    config_profile_id: StrictStr = Field(
        description="The resource identifier.")
    fields: Optional[ProtobufFieldMask] = None
    object_ids: List[StrictStr] = Field(description="The resource identifier.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = [
        "config_profile_id", "fields", "object_ids"
    ]
