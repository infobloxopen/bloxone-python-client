...
class CreateMacAddressItemResponse(BaseModel):
    """
    The response format to create the __MacAddressItem__ object.
    """ # noqa: E501
    result: Optional[MacAddressItem] = Field(
        default=None, description="The created __MacAddressItem__ object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result":
            MacAddressItem.from_dict(obj["result"])
