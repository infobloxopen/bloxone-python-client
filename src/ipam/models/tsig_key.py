...
class TSIGKey(BaseModel):
  ...
  # noqa: E501
    ...
    name: Optional[StrictStr] = Field(default=None,
                                      description="The TSIG key name, FQDN.")
    protocol_name: Optional[StrictStr] = Field(
        default=None, description="The TSIG key name in punycode.")
    secret: Optional[StrictStr] = Field(
        default=None, description="The TSIG key secret, base64 string.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = [
        "algorithm", "comment", "key", "name", "protocol_name", "secret"
    ]
