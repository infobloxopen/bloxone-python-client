...
class ListAncestorResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    results: Optional[List[CidrBlock]] = Field(
        default=None,
        description="The list of the ancestors of the CidrBlock.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [CidrBlock.from_dict(_item) for _item in obj["results"]]
