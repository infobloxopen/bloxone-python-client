...
class OptionItem(BaseModel):
    ...
    option_code: Optional[StrictStr] = Field(
        default=None, description="The resource identifier.")
    option_value: Optional[StrictStr] = Field(default=None,
                                              description="The option value.")
    type: Optional[StrictStr] = Field(
        default=None,
        description="The type of item.  Valid values are: * _group_ * _option_"
    )
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = [
        "group", "option_code", "option_value", "type"
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group": obj.get("group"),
            "option_code": obj.get("option_code"),
            "option_value": obj.get("option_value"),
            "type": obj.get("type")
        })
