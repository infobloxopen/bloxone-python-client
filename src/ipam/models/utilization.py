...
class Utilization(BaseModel):
    ...
    dynamic: Optional[StrictStr] = Field(
        default=None,
        description=
    ...
    used: Optional[StrictStr] = Field(
        default=None,
        description=
        "The number of IP addresses used in the scope of the object.")
    utilization: Optional[Annotated[int, Field(le=100, strict=True)]] = Field(
        default=None,
        description=
    ...
    __properties: ClassVar[List[str]] = [
        "abandon_utilization", "abandoned", "dynamic", "free", "static",
