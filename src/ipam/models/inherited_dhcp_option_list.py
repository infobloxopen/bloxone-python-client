...
class InheritedDHCPOptionList(BaseModel):
    """
    ...
    value: Optional[List[InheritedDHCPOption]] = Field(
        default=None, description="The inherited DHCP option values.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            obj.get("action"),
            "value":
            [InheritedDHCPOption.from_dict(_item) for _item in obj["value"]]
