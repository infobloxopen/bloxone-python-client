...
class HardwareFilter(BaseModel):
    """
    ...
    """ # noqa: E501
    addresses: Optional[List[StrictStr]] = Field(
        default=None,
        description="The list of addresses to match for the hardware filter.")
    ...
    tags: Optional[Dict[str, Any]] = Field(
        default=None,
        description="The tags for the hardware filter in JSON format.")
    ...
    __properties: ClassVar[List[str]] = [
        "addresses", "comment", "created_at", "dhcp_options",
        "header_option_filename", "header_option_server_address",
        "header_option_server_name", "id", "lease_time", "name", "role",
        "tags", "updated_at", "vendor_specific_option_option_space"
    ]
