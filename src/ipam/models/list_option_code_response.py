...
class ListOptionCodeResponse(BaseModel):
    """
    The response format to retrieve __OptionCode__ objects.
    """ # noqa: E501
    results: Optional[List[OptionCode]] = Field(
        default=None, description="The list of OptionCode objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [OptionCode.from_dict(_item) for _item in obj["results"]]
