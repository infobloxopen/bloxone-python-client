...
class CreateNextAvailableSubnetResponse(BaseModel):
    """
    The Next Available Subnet object create response format.
    """ # noqa: E501
    results: Optional[List[Subnet]] = Field(
        default=None, description="The list of Next Available Subnet objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [Subnet.from_dict(_item) for _item in obj["results"]]
