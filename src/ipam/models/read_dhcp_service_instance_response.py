...
class ReadDHCPServiceInstanceResponse(BaseModel):
    """
    The response format to retrieve the DHCP __Service__ object.
    """ # noqa: E501
    result: Optional[DHCPServiceInstance] = Field(
        default=None, description="The DHCP Service object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result":
            DHCPServiceInstance.from_dict(obj["result"])
