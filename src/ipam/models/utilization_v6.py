...
class UtilizationV6(BaseModel):
    """
    The __UtilizationV6__ object represents IPV6 address usage statistics for an object.
    """ # noqa: E501
    abandoned: Optional[Union[StrictBytes, StrictStr]] = None
    dynamic: Optional[Union[StrictBytes, StrictStr]] = None
    static: Optional[Union[StrictBytes, StrictStr]] = None
    total: Optional[Union[StrictBytes, StrictStr]] = None
    used: Optional[Union[StrictBytes, StrictStr]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = [
        "abandoned", "dynamic", "static", "total", "used"
    ]
