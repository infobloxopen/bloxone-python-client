...
class OptionCode(BaseModel):
    ...
    """ # noqa: E501
    array: Optional[StrictBool] = Field(
        default=None,
        description=
        "Indicates whether the option value is an array of the type or not.")
    code: Annotated[int, Field(le=254, strict=True, ge=1)] = Field(
    ...
    option_space: StrictStr = Field(description="The resource identifier.")
    ...
    __properties: ClassVar[List[str]] = [
        "array", "code", "comment", "created_at", "id", "name", "option_space",
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "option_space": obj.get("option_space"),
