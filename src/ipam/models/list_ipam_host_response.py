...
class ListIpamHostResponse(BaseModel):
    """
    The response format to retrieve __IpamHost__ objects.
    """ # noqa: E501
    results: Optional[List[IpamHost]] = Field(
        default=None, description="The list of IpamHost objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [IpamHost.from_dict(_item) for _item in obj["results"]]
