...
class HardwareFilterApi:
    ...
    def create(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateHardwareFilterResponse",
        }
    ...
    def create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateHardwareFilterResponse]:
        """Create the hardware filter.
    ...
    def _create_serialize(
        ...
        return self.api_client.param_serialize(
            ...
            resource_path='/dhcp/hardware_filter',
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            base_path='/api/ddi/v1',
            resource_path='/dhcp/hardware_filter/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListHardwareFilterResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListHardwareFilterResponse]:
        """Retrieve hardware filters.
    ...
    def read(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ReadHardwareFilterResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReadHardwareFilterResponse]:
        """Retrieve the hardware filter.
    ...
    def update(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UpdateHardwareFilterResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateHardwareFilterResponse]:
        """Update the hardware filter.
