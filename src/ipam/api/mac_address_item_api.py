...
class MacAddressItemApi:
    ...
    def bulk_create(
        ...
        _param = self._bulk_create_serialize(body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BulkCreateMacAddressItemResponse",
        }
    ...
    def bulk_create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BulkCreateMacAddressItemResponse]:
        """Bulk create the mac address items.
    ...
    def _bulk_create_serialize(
        ...
        return self.api_client.param_serialize(
            ...
            resource_path='/dhcp/mac_address_item/bulk_create',
    ...
    def create(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateMacAddressItemResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateMacAddressItemResponse]:
        """Create the mac address item.
    ...
    def _create_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/api/ddi/v1',
            resource_path='/dhcp/mac_address_item',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            base_path='/api/ddi/v1',
            resource_path='/dhcp/mac_address_item/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        :type order_by: str
        :param fields:   A collection of response resources can be transformed by specifying a set of JSON tags to be returned. For a â€œflatâ€ resource, the tag name is straightforward. If field selection is allowed on non-flat hierarchical resources, the service should implement a qualified naming scheme such as dot-qualification to reference data down the hierarchy. If a resource does not have the specified tag, the tag does not appear in the output resource.  Specify this parameter as a comma-separated list of JSON tag names.        
        :type fields: str
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListMacAddressItemResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListMacAddressItemResponse]:
        """Retrieve mac address items.
    ...
    def read(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ReadMacAddressItemResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReadMacAddressItemResponse]:
        """Retrieve the mac address item.
    ...
    def update(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UpdateMacAddressItemResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateMacAddressItemResponse]:
        """Update the mac address item.
    ...
    def upload(
        ...
        :param body: (required)
        :type body: MacAddressItemUpload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MacAddressItemUploadResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def upload_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MacAddressItemUploadResponse]:
        """Upload mac addresses to a large scale hardware filter.
    ...
    def _upload_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/api/ddi/v1',
            resource_path='/dhcp/mac_address_item/upload',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
