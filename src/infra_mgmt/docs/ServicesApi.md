...
with ApiClient(config) as api_client:
    ...
    try:
        # List applications (Service types) for a particular account.
        api_response = api_instance.applications()
        pprint("The response of ServicesApi->applications:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling ServicesApi->applications: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of ServicesApi->create:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling ServicesApi->create: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("Exception when calling ServicesApi->delete: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of ServicesApi->list:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling ServicesApi->list: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of ServicesApi->read:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling ServicesApi->read: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of ServicesApi->update:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling ServicesApi->update: %s\n" % e)
```
