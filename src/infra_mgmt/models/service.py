...
class Service(BaseModel):
  ...
  # noqa: E501
    ...
    description: Optional[StrictStr] = Field(
        default=None, description="The description of the Service (optional).")
    ...
    name: StrictStr = Field(description="The name of the Service (unique).")
    ...
    __properties: ClassVar[List[str]] = [
        "configs", "created_at", "description", "desired_state",
        "desired_version", "id", "interface_labels", "name", "pool_id",
        "service_type", "tags", "updated_at"
    ]
