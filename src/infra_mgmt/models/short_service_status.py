...
class ShortServiceStatus(BaseModel):
    """
    ShortServiceStatus
    """
  ...
  # noqa: E501
    message: Optional[StrictStr] = Field(
        default=None, description="Status message text for the Service.")
    ...
    __properties: ClassVar[List[str]] = ["message", "status", "updated_at"]
