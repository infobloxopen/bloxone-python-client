...
class ServiceHostConfig(BaseModel):
    ...
    extra_data: Optional[StrictStr] = Field(
        default=None,
        description=
        "The field to carry any extra data specific to this configuration.")
    host_id: Optional[StrictStr] = Field(
    ...
    __properties: ClassVar[List[str]] = [
        "current_version", "extra_data", "host_id", "id", "service_id",
        "service_type", "upgraded_at"
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "upgraded_at": obj.get("upgraded_at")
        })
