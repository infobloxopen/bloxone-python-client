...
class Host(BaseModel):
  ...
  # noqa: E501
    configs: Optional[List[ServiceHostConfig]] = Field(
        default=None,
        description=
        "The list of Host-specific configurations for each Service deployed on this Host."
    )
    connectivity_monitor: Optional[Dict[str, Any]] = Field(
        default=None,
        description=
    ...
    description: Optional[StrictStr] = Field(
        default=None, description="The description of the Host (optional).")
    ...
    host_type: Optional[StrictStr] = Field(
        default=None,
        description=
    ...
    noa_cluster: Optional[StrictStr] = Field(
        default=None,
    ...
    __properties: ClassVar[List[str]] = [
        "configs", "connectivity_monitor", "created_at", "created_by",
        "description", "display_name", "host_subtype", "host_type",
        "host_version", "id", "ip_address", "ip_space", "legacy_id",
        "location_id", "mac_address", "maintenance_mode", "nat_ip",
        "noa_cluster", "ophid", "pool_id", "serial_number", "tags", "timezone",
        "updated_at"
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs":
            [ServiceHostConfig.from_dict(_item) for _item in obj["configs"]]
