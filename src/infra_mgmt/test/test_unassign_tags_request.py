...
class TestUnassignTagsRequest(unittest.TestCase):
    """UnassignTagsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnassignTagsRequest:
        """Test UnassignTagsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnassignTagsRequest`
        """
        model = UnassignTagsRequest()
        if include_optional:
            return UnassignTagsRequest(
                ids = [
                    ''
                    ],
                keys = [
    ...
    def testUnassignTagsRequest(self):
        """Test UnassignTagsRequest"""
