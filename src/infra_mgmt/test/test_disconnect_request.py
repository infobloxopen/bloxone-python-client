...
class TestDisconnectRequest(unittest.TestCase):
    """DisconnectRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisconnectRequest:
        """Test DisconnectRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisconnectRequest`
        """
    ...
    def testDisconnectRequest(self):
        """Test DisconnectRequest"""
