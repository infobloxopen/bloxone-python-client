...
class TestListServiceResponse(unittest.TestCase):
    """ListServiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListServiceResponse:
        """Test ListServiceResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListServiceResponse`
        """
        ...
        if include_optional:
            return ListServiceResponse(
                page = infra_mgmt.models.api_page_info.apiPageInfo(
                    ...
                    size = 56, ),
                results = [
                    infra_mgmt.models.service.Service(
                        configs = [
    ...
    def testListServiceResponse(self):
        """Test ListServiceResponse"""
