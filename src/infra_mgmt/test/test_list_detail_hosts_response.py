...
class TestListDetailHostsResponse(unittest.TestCase):
    """ListDetailHostsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListDetailHostsResponse:
        """Test ListDetailHostsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListDetailHostsResponse`
        """
        model = ListDetailHostsResponse()
        if include_optional:
            return ListDetailHostsResponse(
                page = infra_mgmt.models.api_page_info.apiPageInfo(
                    ...
                    size = 56, ),
                results = [
                    infra_mgmt.models.detail_host.DetailHost(
                        composite_status = '', 
                        configs = [
...
"connectivity_monitor": {"cost":1000000,"endpoint_type":"csp","endpoint":"http://csp.infoblox.com","interval":15}(), 
    ...
    def testListDetailHostsResponse(self):
        """Test ListDetailHostsResponse"""
