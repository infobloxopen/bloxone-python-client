...
class TestReplaceHostRequest(unittest.TestCase):
    """ReplaceHostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplaceHostRequest:
        """Test ReplaceHostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplaceHostRequest`
        """
        model = ReplaceHostRequest()
        if include_optional:
            return ReplaceHostRequest(
                var_from = '',
                to = ''
            )
        else:
    ...
    def testReplaceHostRequest(self):
        """Test ReplaceHostRequest"""
