...
class TestDetailServiceHostConfig(unittest.TestCase):
    """DetailServiceHostConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetailServiceHostConfig:
        """Test DetailServiceHostConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetailServiceHostConfig`
        """
        model = DetailServiceHostConfig()
        if include_optional:
            return DetailServiceHostConfig(
                current_version = '',
    ...
    def testDetailServiceHostConfig(self):
        """Test DetailServiceHostConfig"""
