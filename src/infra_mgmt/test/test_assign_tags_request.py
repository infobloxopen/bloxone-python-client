...
class TestAssignTagsRequest(unittest.TestCase):
    """AssignTagsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignTagsRequest:
        """Test AssignTagsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignTagsRequest`
        """
    ...
    def testAssignTagsRequest(self):
        """Test AssignTagsRequest"""
