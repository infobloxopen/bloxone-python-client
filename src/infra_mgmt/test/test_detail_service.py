...
class TestDetailService(unittest.TestCase):
    """DetailService unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetailService:
        """Test DetailService
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetailService`
        """
        model = DetailService()
        if include_optional:
