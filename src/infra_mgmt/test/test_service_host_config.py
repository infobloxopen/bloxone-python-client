...
class TestServiceHostConfig(unittest.TestCase):
    """ServiceHostConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceHostConfig:
        """Test ServiceHostConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceHostConfig`
        """
        model = ServiceHostConfig()
        if include_optional:
    ...
    def testServiceHostConfig(self):
        """Test ServiceHostConfig"""
