...
class TestDetailServiceHost(unittest.TestCase):
    """DetailServiceHost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetailServiceHost:
        """Test DetailServiceHost
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetailServiceHost`
        """
        model = DetailServiceHost()
        if include_optional:
            return DetailServiceHost(
                composite_status = '',
    ...
    def testDetailServiceHost(self):
        """Test DetailServiceHost"""
