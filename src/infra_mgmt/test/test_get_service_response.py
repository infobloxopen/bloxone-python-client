...
class TestGetServiceResponse(unittest.TestCase):
    """GetServiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetServiceResponse:
        """Test GetServiceResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetServiceResponse`
        """
    ...
    def testGetServiceResponse(self):
        """Test GetServiceResponse"""
