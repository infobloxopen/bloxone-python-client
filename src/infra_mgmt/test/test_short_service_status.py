...
class TestShortServiceStatus(unittest.TestCase):
    """ShortServiceStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShortServiceStatus:
        """Test ShortServiceStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShortServiceStatus`
        """
        model = ShortServiceStatus()
        if include_optional:
            return ShortServiceStatus(
                message = '',
                status = '',
    ...
    def testShortServiceStatus(self):
        """Test ShortServiceStatus"""
