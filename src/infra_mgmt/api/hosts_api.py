...
class HostsApi:
    ...
    def _assign_tags_serialize(
        ...
        return self.api_client.param_serialize(
            ...
            resource_path='/hosts/assign_tags',
    ...
    def create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateHostResponse]:
        """Create a Host resource.
    ...
    def _disconnect_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/api/infra/v1',
            resource_path='/hosts/{id}/disconnect',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def replace(
        ...
        :param from_resource_id: An application specific resource identity of a resource (required)
        :type from_resource_id: str
        :param to_resource_id: An application specific resource identity of a resource (required)
        :type to_resource_id: str
        :param body: (required)
        :type body: ReplaceHostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _replace_serialize(
        ...
        if from_resource_id is not None:
            _path_params[
                'from.resource_id'] = self.api_client.path_param_value(
                    'from.resource_id', from_resource_id)
        if to_resource_id is not None:
            _path_params['to.resource_id'] = self.api_client.path_param_value(
                'to.resource_id', to_resource_id)
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/api/infra/v1',
            resource_path='/hosts/{from.resource_id}/replace/{to.resource_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unassign_tags_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/api/infra/v1',
            resource_path='/hosts/unassign_tags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateHostResponse]:
        """Update a Host resource.
