...
class ObjectType(BaseModel):
  ...
  # noqa: E501
    discover_new: Optional[StrictBool] = None
    objects: Optional[List[Object]] = None
    version: Optional[Union[StrictFloat, StrictInt]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["discover_new", "objects", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discover_new":
            obj.get("discover_new"),
            "objects": [Object.from_dict(_item) for _item in obj["objects"]]
