...
class CredentialPreference(BaseModel):
    """
    CredentialPreference
    """

  # noqa: E501
    access_identifier_type: Optional[StrictStr] = None
    credential_type: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = [
        "access_identifier_type", "credential_type"
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            obj.get("access_identifier_type"),
            "credential_type":
            obj.get("credential_type")
        })
