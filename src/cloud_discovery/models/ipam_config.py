...
class IPAMConfig(BaseModel):
  ...
  # noqa: E501
    ...
    disable_ipam_projection: Optional[StrictBool] = Field(
        default=None,
        description=
        "This flag controls the IPAM Sync/Reconciliation for the provider")
    ip_space: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = [
        "dhcp_server", "disable_ipam_projection", "ip_space"
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            obj.get("disable_ipam_projection"),
            "ip_space":
            obj.get("ip_space")
        })
