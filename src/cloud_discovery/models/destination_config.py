...
class DestinationConfig(BaseModel):
  ...
  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["dns", "ipam"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dns":
            DNSConfig.from_dict(obj["dns"])
            if obj.get("dns") is not None else None,
            "ipam":
            IPAMConfig.from_dict(obj["ipam"])
            if obj.get("ipam") is not None else None
        })
