...
class AdditionalConfig(BaseModel):
  ...
  # noqa: E501
    excluded_accounts: Optional[List[StrictStr]] = None
    forward_zone_enabled: Optional[StrictBool] = None
    internal_ranges_enabled: Optional[StrictBool] = None
    object_type: Optional[ObjectType] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = [
        "excluded_accounts", "forward_zone_enabled", "internal_ranges_enabled",
        "object_type"
    ]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.object_type:
            _dict['object_type'] = self.object_type.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "excluded_accounts":
            obj.get("excluded_accounts"),
            "forward_zone_enabled":
            obj.get("forward_zone_enabled"),
            "internal_ranges_enabled":
            obj.get("internal_ranges_enabled"),
            "object_type":
            ObjectType.from_dict(obj["object_type"])
            if obj.get("object_type") is not None else None
        })
