...
class TestCustomRedirect(unittest.TestCase):
    """CustomRedirect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomRedirect:
        """Test CustomRedirect
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomRedirect`
        """
        model = CustomRedirect()
        if include_optional:
