...
class ProxyCertResponse(BaseModel):
    """
    ProxyCertResponse
    """

  # noqa: E501
    anycast_dns_certificate_url: Optional[StrictStr] = Field(
        default=None,
        description="Infoblox anycast dns client certificate URL.")
    certificate_url: Optional[StrictStr] = Field(
        default=None, description="The certificate URL.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = [
        "anycast_dns_certificate_url", "certificate_url"
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            obj.get("anycast_dns_certificate_url"),
            "certificate_url":
            obj.get("certificate_url")
        })
