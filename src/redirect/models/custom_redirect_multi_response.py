...
class CustomRedirectMultiResponse(BaseModel):
    """
    The Custom Redirect list response.
    """

  # noqa: E501
    results: Optional[List[CustomRedirect]] = Field(
        default=None, description="The list of Custom Redirect objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [CustomRedirect.from_dict(_item) for _item in obj["results"]]
