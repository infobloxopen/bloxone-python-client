...
class CustomRedirectsCreateCustomRedirect400Response(BaseModel):
    """
    CustomRedirectsCreateCustomRedirect400Response
    """ # noqa: E501
    error: Optional[CustomRedirectsCreateCustomRedirect400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            CustomRedirectsCreateCustomRedirect400ResponseError.from_dict(
