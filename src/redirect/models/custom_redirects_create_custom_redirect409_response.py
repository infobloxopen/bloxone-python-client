...
class CustomRedirectsCreateCustomRedirect409Response(BaseModel):
    """
    CustomRedirectsCreateCustomRedirect409Response
    """ # noqa: E501
    error: Optional[CustomRedirectsCreateCustomRedirect409ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            CustomRedirectsCreateCustomRedirect409ResponseError.from_dict(
