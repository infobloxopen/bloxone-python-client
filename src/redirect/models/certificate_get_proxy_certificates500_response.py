...
class CertificateGetProxyCertificates500Response(BaseModel):
    """
    CertificateGetProxyCertificates500Response
    """

  # noqa: E501
    error: Optional[CertificateGetProxyCertificates500ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            CertificateGetProxyCertificates500ResponseError.from_dict(
