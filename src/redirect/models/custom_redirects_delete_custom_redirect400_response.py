...
class CustomRedirectsDeleteCustomRedirect400Response(BaseModel):
    """
    CustomRedirectsDeleteCustomRedirect400Response
    """ # noqa: E501
    error: Optional[CustomRedirectsDeleteCustomRedirect400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            CustomRedirectsDeleteCustomRedirect400ResponseError.from_dict(
