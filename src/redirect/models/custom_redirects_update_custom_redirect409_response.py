...
class CustomRedirectsUpdateCustomRedirect409Response(BaseModel):
    """
    CustomRedirectsUpdateCustomRedirect409Response
    """ # noqa: E501
    error: Optional[CustomRedirectsUpdateCustomRedirect409ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error":
            CustomRedirectsUpdateCustomRedirect409ResponseError.from_dict(
