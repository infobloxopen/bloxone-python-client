...
class RedirectPageApi:
    ...
    def read_redirect_page(
        ...
        _param = self._read_redirect_page_serialize(
            filter=filter,
            fields=fields,
    ...
    @validate_call
    def read_redirect_page_with_http_info(
        self,
        filter: Annotated[
            Optional[StrictStr],
            Field(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RedirectPageReadResponse]:
        """Read Redirect Page.
    ...
    @validate_call
    def read_redirect_page_without_preload_content(
        self,
        filter: Annotated[
            Optional[StrictStr],
            Field(
    ...
    def _read_redirect_page_serialize(
        self,
        filter,
        fields,
        _request_auth,
    ...
    @validate_call
    def update_redirect_page(
        self,
        body: Annotated[UpdateRedirectPagePayload,
                        Field(description="The Redirect Page object.")],
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
                                Tuple[Annotated[StrictFloat,
                                                Field(gt=0)],
        ...
        :param body: The Redirect Page object. (required)
        :type body: UpdateRedirectPagePayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_redirect_page_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RedirectPageUpdateResponse",
            '400': "PageUpdateRedirectPage400Response",
            '500': "CertificateGetProxyCertificates500Response",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
    ...
    @validate_call
    def update_redirect_page_with_http_info(
        self,
        body: Annotated[UpdateRedirectPagePayload,
                        Field(description="The Redirect Page object.")],
        _request_timeout: Union[None, Annotated[StrictFloat,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RedirectPageUpdateResponse]:
        """Update Redirect Page.
    ...
    @validate_call
    def update_redirect_page_without_preload_content(
        self,
        body: Annotated[UpdateRedirectPagePayload,
                        Field(description="The Redirect Page object.")],
        _request_timeout: Union[None, Annotated[StrictFloat,
    ...
    def _update_redirect_page_serialize(
        self,
        body,
        _request_auth,
        _content_type,
