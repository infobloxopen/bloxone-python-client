...
class TestReadRecordResponse(unittest.TestCase):
    """ReadRecordResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadRecordResponse:
        """Test ReadRecordResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadRecordResponse`
        """
        model = ReadRecordResponse()
        if include_optional:
    ...
    def testReadRecordResponse(self):
        """Test ReadRecordResponse"""
