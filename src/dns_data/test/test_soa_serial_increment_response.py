...
class TestSOASerialIncrementResponse(unittest.TestCase):
    """SOASerialIncrementResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SOASerialIncrementResponse:
        """Test SOASerialIncrementResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SOASerialIncrementResponse`
        """
        model = SOASerialIncrementResponse()
        if include_optional:
    ...
    def testSOASerialIncrementResponse(self):
        """Test SOASerialIncrementResponse"""
