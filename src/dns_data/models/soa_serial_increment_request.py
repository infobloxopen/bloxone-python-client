...
class SOASerialIncrementRequest(BaseModel):
    """
  ...
  # noqa: E501
    ...
    serial_increment: Optional[StrictInt] = Field(
        default=None,
        description="Default increment SOA serial number by 1,000.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["fields", "id", "serial_increment"]
