...
class TestTypesJSONValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TypesJSONValue:
        """Test TypesJSONValue
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypesJSONValue`
        """
        model = TypesJSONValue()
        if include_optional:
            return TypesJSONValue(
                value = ''
            )
        else:
            return TypesJSONValue(
