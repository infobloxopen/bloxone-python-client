...
class TestCreateJoinTokenResponse(unittest.TestCase):
    """CreateJoinTokenResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateJoinTokenResponse:
        """Test CreateJoinTokenResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateJoinTokenResponse`
        """
        model = CreateJoinTokenResponse()
        if include_optional:
    ...
    def testCreateJoinTokenResponse(self):
        """Test CreateJoinTokenResponse"""
