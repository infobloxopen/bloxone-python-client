...
class TestListJoinTokenResponse(unittest.TestCase):
    """ListJoinTokenResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListJoinTokenResponse:
        """Test ListJoinTokenResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListJoinTokenResponse`
        """
        model = ListJoinTokenResponse()
        if include_optional:
            return ListJoinTokenResponse(
                page = infra_provision.models.api_page_info.apiPageInfo(
                    offset = 56, 
                    page_token = '', 
                    size = 56, ),
                results = [
                    infra_provision.models.hostactivation_join_token.hostactivationJoinToken(
    ...
    def testListJoinTokenResponse(self):
        """Test ListJoinTokenResponse"""
