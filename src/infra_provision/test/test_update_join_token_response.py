...
class TestUpdateJoinTokenResponse(unittest.TestCase):
    """UpdateJoinTokenResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateJoinTokenResponse:
        """Test UpdateJoinTokenResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateJoinTokenResponse`
        """
        model = UpdateJoinTokenResponse()
        if include_optional:
    ...
    def testUpdateJoinTokenResponse(self):
        """Test UpdateJoinTokenResponse"""
