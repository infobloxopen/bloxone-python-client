...
class TestListCSRsResponse(unittest.TestCase):
    """ListCSRsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCSRsResponse:
        """Test ListCSRsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCSRsResponse`
        """
        model = ListCSRsResponse()
        if include_optional:
            return ListCSRsResponse(
                page = infra_provision.models.api_page_info.apiPageInfo(
                    ...
                    size = 56, ),
                results = [
                    infra_provision.models.hostactivation_csr.hostactivationCSR(
                        activation_code = '', 
