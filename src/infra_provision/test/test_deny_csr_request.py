...
class TestDenyCSRRequest(unittest.TestCase):
    """DenyCSRRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DenyCSRRequest:
        """Test DenyCSRRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DenyCSRRequest`
        """
        model = DenyCSRRequest()
        if include_optional:
            return DenyCSRRequest(
                activation_code = ''
            )
        else:
            return DenyCSRRequest(
