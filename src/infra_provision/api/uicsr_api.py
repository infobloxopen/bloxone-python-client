...
class UICSRApi:
    ...
    def approve(
        ...
        activation_code: Annotated[
            ...
            Field(
                description=
                "activation code is used by the clients to track the approval of the CSR"
            )],
        ...
        :param activation_code: activation code is used by the clients to track the approval of the CSR (required)
        :type activation_code: str
        :param body: (required)
        :type body: ApproveCSRRequest
    ...
    def _approve_serialize(
        ...
        if activation_code is not None:
            _path_params['activation_code'] = self.api_client.path_param_value(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/host-activation/v1',
            resource_path='/csr/{activation_code}/approve',
    ...
    def _deny_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/host-activation/v1',
            resource_path='/csr/{activation_code}/deny',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def revoke(
        ...
        cert_serial: Annotated[
            ...
            Field(
                description=
                "x509 serial number of the certificate. This can be obtained by parsing the client certificate file on the onprem. Either cert_serial or ophid is required"
            )],
        ...
        :param cert_serial: x509 serial number of the certificate. This can be obtained by parsing the client certificate file on the onprem. Either cert_serial or ophid is required (required)
        :type cert_serial: str
        :param body: (required)
    ...
    def _revoke_serialize(
        ...
        if cert_serial is not None:
            _path_params['cert_serial'] = self.api_client.path_param_value(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/host-activation/v1',
            resource_path='/cert/{cert_serial}/revoke',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _revoke2_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/host-activation/v1',
            resource_path='/host/{ophid}/revoke',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
