...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of HostApi->list:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling HostApi->list: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of HostApi->read:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling HostApi->read: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of HostApi->update:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling HostApi->update: %s\n" % e)
```
