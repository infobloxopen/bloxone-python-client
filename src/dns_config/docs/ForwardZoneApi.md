...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of ForwardZoneApi->copy:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling ForwardZoneApi->copy: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of ForwardZoneApi->create:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling ForwardZoneApi->create: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("Exception when calling ForwardZoneApi->delete: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of ForwardZoneApi->list:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling ForwardZoneApi->list: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of ForwardZoneApi->read:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling ForwardZoneApi->read: %s\n" % e)
```
...
with ApiClient(config) as api_client:
    ...
    try:
        ...
        pprint("The response of ForwardZoneApi->update:\n")
        pprint(api_response)
    except Exception as e:
        pprint("Exception when calling ForwardZoneApi->update: %s\n" % e)
```
