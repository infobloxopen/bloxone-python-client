...
class SortListItem(BaseModel):
  ...
  # noqa: E501
    acl: Optional[StrictStr] = Field(default=None,
                                     description="The resource identifier.")
    element: StrictStr = Field(
        description=
        "Type of element.  Allowed values:  * _any_,  * _ip_,  * _acl_,")
    prioritized_networks: Optional[List[StrictStr]] = Field(
        default=None,
        description=
    ...
    source: Optional[StrictStr] = Field(
        default=None, description="Must be empty if _element_ is not _ip_.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = [
        "acl", "element", "prioritized_networks", "source"
    ]
