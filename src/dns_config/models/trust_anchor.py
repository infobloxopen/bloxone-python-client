...
class TrustAnchor(BaseModel):
  ...
  # noqa: E501
    algorithm: StrictInt
    protocol_zone: Optional[StrictStr] = Field(
    ...
    sep: Optional[StrictBool] = Field(
        default=None,
        description="Optional. Secure Entry Point flag.  Defaults to _true_.")
    zone: StrictStr = Field(description="Zone FQDN.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = [
        "algorithm", "protocol_zone", "public_key", "sep", "zone"
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "protocol_zone": obj.get("protocol_zone"),
