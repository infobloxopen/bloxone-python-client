...
class RootNS(BaseModel):
    """
    Root nameserver
    """

  # noqa: E501
    address: StrictStr = Field(description="IPv4 address.")
    fqdn: StrictStr = Field(description="FQDN.")
    protocol_fqdn: Optional[StrictStr] = Field(default=None,
