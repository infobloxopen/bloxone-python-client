...
class ListForwardNSGResponse(BaseModel):
    """
    The ForwardNSG object list response format.
    """

  # noqa: E501
    results: Optional[List[ForwardNSG]] = Field(
        default=None, description="List of ForwardNSG objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [ForwardNSG.from_dict(_item) for _item in obj["results"]]
