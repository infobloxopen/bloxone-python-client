...
class ListDelegationResponse(BaseModel):
    """
    The Delegation object list response format.
    """

  # noqa: E501
    results: Optional[List[Delegation]] = Field(
        default=None, description="The list of Delegation objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [Delegation.from_dict(_item) for _item in obj["results"]]
