...
class ListAuthNSGResponse(BaseModel):
    """
    The AuthNSG object list response format.
    """

  # noqa: E501
    results: Optional[List[AuthNSG]] = Field(
        default=None, description="List of AuthNSG objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [AuthNSG.from_dict(_item) for _item in obj["results"]]
