...
class ZoneAuthority(BaseModel):
    ...
    """ # noqa: E501
    default_ttl: Optional[StrictInt] = Field(
        default=None,
        description=
        "Optional. ZoneAuthority default ttl for resource records in zone (value in seconds).  Defaults to 28800."
    )
    expire: Optional[StrictInt] = Field(
        default=None,
        description=
        "Optional. ZoneAuthority expire time in seconds.  Defaults to 2419200."
    )
    mname: Optional[StrictStr] = Field(default=None,
                                       description="Defaults to empty.")
    negative_ttl: Optional[StrictInt] = Field(
        default=None,
        description=
        "Optional. ZoneAuthority negative caching (minimum) ttl in seconds.  Defaults to 900."
    )
    protocol_mname: Optional[StrictStr] = Field(
        default=None,
        description=
        "Optional. ZoneAuthority master name server in punycode.  Defaults to empty."
    )
    protocol_rname: Optional[StrictStr] = Field(
        default=None,
        description=
        "Optional. A domain name which specifies the mailbox of the person responsible for this zone.  Defaults to empty."
    )
    refresh: Optional[StrictInt] = Field(
        default=None,
        description="Optional. ZoneAuthority refresh.  Defaults to 10800.")
    retry: Optional[StrictInt] = Field(
        default=None,
        description="Optional. ZoneAuthority retry.  Defaults to 3600.")
    rname: Optional[StrictStr] = Field(
        default=None,
        description="Optional. ZoneAuthority rname.  Defaults to empty.")
    use_default_mname: Optional[StrictBool] = Field(
        default=None,
        description=
    ...
    __properties: ClassVar[List[str]] = [
        "default_ttl", "expire", "mname", "negative_ttl", "protocol_mname",
        "protocol_rname", "refresh", "retry", "rname", "use_default_mname"
    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            obj.get("mname"),
            "negative_ttl":
            obj.get("negative_ttl"),
            "protocol_mname":
            obj.get("protocol_mname"),
            "protocol_rname":
            obj.get("protocol_rname"),
            "refresh":
            obj.get("refresh"),
            "retry":
            obj.get("retry"),
