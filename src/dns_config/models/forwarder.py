...
class Forwarder(BaseModel):
  ...
  # noqa: E501
    address: StrictStr = Field(description="Server IP address.")
    fqdn: Optional[StrictStr] = Field(default=None, description="Server FQDN.")
    protocol_fqdn: Optional[StrictStr] = Field(
        default=None, description="Server FQDN in punycode.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["address", "fqdn", "protocol_fqdn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fqdn": obj.get("fqdn"),
            "protocol_fqdn": obj.get("protocol_fqdn")
        })
