...
class ListAuthZoneResponse(BaseModel):
    """
    The Authoritative Zone object list response format.
    """ # noqa: E501
    results: Optional[List[AuthZone]] = Field(
        default=None, description="The list of Auth Zone objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [AuthZone.from_dict(_item) for _item in obj["results"]]
