...
class ListForwardZoneResponse(BaseModel):
    """
    The Forward Zone objects list response format.
    """ # noqa: E501
    results: Optional[List[ForwardZone]] = Field(
        default=None, description="List of Forward Zone objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [ForwardZone.from_dict(_item) for _item in obj["results"]]
