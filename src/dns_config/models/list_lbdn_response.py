...
class ListLBDNResponse(BaseModel):
    """
    The __LBDN__ object list response format.
    """

  # noqa: E501
    results: Optional[List[LBDN]] = Field(
        default=None, description="List of __LBDN__ objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [LBDN.from_dict(_item) for _item in obj["results"]]
