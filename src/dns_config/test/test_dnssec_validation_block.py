...
class TestDNSSECValidationBlock(unittest.TestCase):
    """DNSSECValidationBlock unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DNSSECValidationBlock:
        """Test DNSSECValidationBlock
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DNSSECValidationBlock`
        """
        model = DNSSECValidationBlock()
        if include_optional:
    ...
    def testDNSSECValidationBlock(self):
        """Test DNSSECValidationBlock"""
