...
class TestReadAuthNSGResponse(unittest.TestCase):
    """ReadAuthNSGResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadAuthNSGResponse:
        """Test ReadAuthNSGResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadAuthNSGResponse`
        """
        model = ReadAuthNSGResponse()
        if include_optional:
    ...
    def testReadAuthNSGResponse(self):
        """Test ReadAuthNSGResponse"""
