...
class TestReadLBDNResponse(unittest.TestCase):
    """ReadLBDNResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadLBDNResponse:
        """Test ReadLBDNResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadLBDNResponse`
        """
        model = ReadLBDNResponse()
        if include_optional:
