...
class TestListAuthZoneResponse(unittest.TestCase):
    """ListAuthZoneResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAuthZoneResponse:
        """Test ListAuthZoneResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAuthZoneResponse`
        """
        model = ListAuthZoneResponse()
        if include_optional:
            return ListAuthZoneResponse(
                results = [
                    dns_config.models.auth_zone.AuthZone(
                        comment = '', 
    ...
    def testListAuthZoneResponse(self):
        """Test ListAuthZoneResponse"""
