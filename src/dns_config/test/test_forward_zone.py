...
class TestForwardZone(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ForwardZone:
        """Test ForwardZone
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForwardZone`
        """
        model = ForwardZone()
        if include_optional:
            return ForwardZone(
