...
class TestDNSGlobal(unittest.TestCase):
    """DNSGlobal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DNSGlobal:
        """Test DNSGlobal
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DNSGlobal`
        """
        model = DNSGlobal()
        if include_optional:
            return DNSGlobal(
