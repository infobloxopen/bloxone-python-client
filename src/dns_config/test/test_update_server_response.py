...
class TestUpdateServerResponse(unittest.TestCase):
    """UpdateServerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateServerResponse:
        """Test UpdateServerResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateServerResponse`
        """
        model = UpdateServerResponse()
        if include_optional:
            return UpdateServerResponse(
                result = dns_config.models.server.Server(
    ...
    def testUpdateServerResponse(self):
        """Test UpdateServerResponse"""
