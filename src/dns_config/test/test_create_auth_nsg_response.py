...
class TestCreateAuthNSGResponse(unittest.TestCase):
    """CreateAuthNSGResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateAuthNSGResponse:
        """Test CreateAuthNSGResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAuthNSGResponse`
        """
        model = CreateAuthNSGResponse()
        if include_optional:
    ...
    def testCreateAuthNSGResponse(self):
        """Test CreateAuthNSGResponse"""
