...
class TestCopyAuthZone(unittest.TestCase):
    """CopyAuthZone unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CopyAuthZone:
        """Test CopyAuthZone
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CopyAuthZone`
        """
        model = CopyAuthZone()
        if include_optional:
            return CopyAuthZone(
