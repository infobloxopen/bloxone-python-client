...
class TestAuthZone(unittest.TestCase):
    """AuthZone unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthZone:
        """Test AuthZone
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthZone`
        """
        model = AuthZone()
        if include_optional:
            return AuthZone(
