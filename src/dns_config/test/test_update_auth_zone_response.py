...
class TestUpdateAuthZoneResponse(unittest.TestCase):
    """UpdateAuthZoneResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAuthZoneResponse:
        """Test UpdateAuthZoneResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAuthZoneResponse`
        """
        model = UpdateAuthZoneResponse()
        if include_optional:
    ...
    def testUpdateAuthZoneResponse(self):
        """Test UpdateAuthZoneResponse"""
