...
class TestAuthZoneConfig(unittest.TestCase):
    """AuthZoneConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthZoneConfig:
        """Test AuthZoneConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthZoneConfig`
        """
        model = AuthZoneConfig()
        if include_optional:
