...
class TestCreateServerResponse(unittest.TestCase):
    """CreateServerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateServerResponse:
        """Test CreateServerResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateServerResponse`
        """
    ...
    def testCreateServerResponse(self):
        """Test CreateServerResponse"""
