...
class TestListAuthNSGResponse(unittest.TestCase):
    """ListAuthNSGResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAuthNSGResponse:
        """Test ListAuthNSGResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAuthNSGResponse`
        """
        model = ListAuthNSGResponse()
        if include_optional:
            return ListAuthNSGResponse(
                results = [
                    dns_config.models.auth_nsg.AuthNSG(
                        comment = '', 
                        external_primaries = [
    ...
    def testListAuthNSGResponse(self):
        """Test ListAuthNSGResponse"""
