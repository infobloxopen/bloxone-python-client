...
class TestViewInheritance(unittest.TestCase):
    """ViewInheritance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewInheritance:
        """Test ViewInheritance
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewInheritance`
        """
        model = ViewInheritance()
        if include_optional:
            return ViewInheritance(
                ...
                dtc_config = dns_config.models.inherited_dtc_config.InheritedDtcConfig(
                ...
                max_negative_ttl = dns_config.models.inherited_u_int32.InheritedUInt32(
                    ...
                    source = '', 
                    value = 56, ),
                max_udp_size = dns_config.models.inherited_u_int32.InheritedUInt32(
                    action = '', 
                    display_name = '', 
                    source = '', 
                    value = 56, ),
