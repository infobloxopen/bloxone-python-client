...
class TestListViewResponse(unittest.TestCase):
    """ListViewResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListViewResponse:
        """Test ListViewResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListViewResponse`
        """
        model = ListViewResponse()
        if include_optional:
            return ListViewResponse(
                results = [
                    dns_config.models.view.View(
