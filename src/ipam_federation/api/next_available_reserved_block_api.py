...
class NextAvailableReservedBlockApi:
    ...
    @validate_call
    def list_next_available_reserved_blocks(
        self,
        id: Annotated[
            StrictStr,
            Field(description=
        ...
        _param = self._list_next_available_reserved_blocks_serialize(
            id=id,
            cidr=cidr,
            count=count,
            name=name,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListNextAvailableReservedBlockResponse",
        }
    ...
    @validate_call
    def list_next_available_reserved_blocks_with_http_info(
        self,
        id: Annotated[
            StrictStr,
            Field(description=
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListNextAvailableReservedBlockResponse]:
        """List the next available reserved block.
    ...
    @validate_call
    def list_next_available_reserved_blocks_without_preload_content(
        self,
        id: Annotated[
            StrictStr,
            Field(description=
    ...
    def _list_next_available_reserved_blocks_serialize(
        self,
        id,
        cidr,
        count,
