...
class CreateFederatedRealmResponse(BaseModel):
    """
    The response format to create the __FederatedRealm__ object.
    """ # noqa: E501
    result: Optional[FederatedRealm] = Field(
        default=None, description="The created Federated Realm object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result":
            FederatedRealm.from_dict(obj["result"])
