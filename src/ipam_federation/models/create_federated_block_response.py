...
class CreateFederatedBlockResponse(BaseModel):
    """
    The response format to create the __FederatedBlock__ object.
    """ # noqa: E501
    result: Optional[FederatedBlock] = Field(
        default=None, description="The created FederatedBlock object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result":
            FederatedBlock.from_dict(obj["result"])
