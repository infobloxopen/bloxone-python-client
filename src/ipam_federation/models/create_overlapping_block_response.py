...
class CreateOverlappingBlockResponse(BaseModel):
    """
    The response format to create the __OverlappingBlock__ object.
    """ # noqa: E501
    result: Optional[OverlappingBlock] = Field(
        default=None, description="The created OverlappingBlock object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result":
            OverlappingBlock.from_dict(obj["result"])
