...
class ListReservedBlockResponse(BaseModel):
    """
    The response format to retrieve __ReservedBlock__ objects.
    """ # noqa: E501
    results: Optional[List[ReservedBlock]] = Field(
        default=None, description="A list of ReservedBlock objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [ReservedBlock.from_dict(_item) for _item in obj["results"]]
