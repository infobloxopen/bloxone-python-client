...
class CreateReservedBlockResponse(BaseModel):
    """
    The response format to create the __ReservedBlock__ object.
    """ # noqa: E501
    result: Optional[ReservedBlock] = Field(
        default=None, description="The created ReservedBlock object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result":
            ReservedBlock.from_dict(obj["result"])
