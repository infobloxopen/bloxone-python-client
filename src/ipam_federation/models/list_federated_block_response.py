...
class ListFederatedBlockResponse(BaseModel):
    """
    The response format to retrieve __FederatedBlock__ objects.
    """ # noqa: E501
    results: Optional[List[FederatedBlock]] = Field(
        default=None, description="A list of FederatedBlock objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [FederatedBlock.from_dict(_item) for _item in obj["results"]]
