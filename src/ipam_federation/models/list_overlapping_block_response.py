...
class ListOverlappingBlockResponse(BaseModel):
    """
    The response format to retrieve __OverlappingBlock__ objects.
    """ # noqa: E501
    results: Optional[List[OverlappingBlock]] = Field(
        default=None, description="A list of OverlappingBlock objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [OverlappingBlock.from_dict(_item) for _item in obj["results"]]
