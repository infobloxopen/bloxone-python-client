...
class BatchMaintenanceWindowResult(BaseModel):
    """
    BatchMaintenanceWindowResult
    """

  # noqa: E501
    created_ids: Optional[List[StrictStr]] = None
    updated_mws: Optional[List[MaintenanceWindow]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["created_ids", "updated_mws"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in updated_mws (list)
        _items = []
        if self.updated_mws:
            for _item in self.updated_mws:
                if _item:
                    _items.append(_item.to_dict())
            _dict['updated_mws'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            obj.get("created_ids"),
            "updated_mws": [
                MaintenanceWindow.from_dict(_item)
                for _item in obj["updated_mws"]
            ] if obj.get("updated_mws") is not None else None
        })
