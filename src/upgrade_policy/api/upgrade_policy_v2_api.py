...
class UpgradePolicyV2Api:
    ...
    def apply_config_now(
        ...
        :param body: (required)
        :type body: ApplyConfigNowRequest
        ...
        _param = self._apply_config_now_serialize(body=body,
    ...
    @validate_call
    def apply_config_now_with_http_info(
        self,
        body: ApplyConfigNowRequest,
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApplyConfigNowResponse]:
        """Immediately apply the config updates object to the list of hosts
    ...
    @validate_call
    def apply_config_now_without_preload_content(
        self,
        body: ApplyConfigNowRequest,
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
    ...
    def _apply_config_now_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/api/upgrade_policy',
            resource_path='/v2/config/apply_now',
    ...
    def batch(
        ...
        :param body: (required)
        :type body: BatchMaintenanceWindowRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._batch_serialize(body=body,
                                       _request_auth=_request_auth,
                                       _content_type=_content_type,
                                       _headers=_headers,
                                       _host_index=_host_index)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "BatchMaintenanceWindowResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def batch_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BatchMaintenanceWindowResponse]:
        """Create, update and/or delete multiple maintenance windows in a single request
    ...
    def _batch_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/api/upgrade_policy',
            resource_path='/v2/maintenance_windows/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def create(
        ...
        :param body: (required)
        :type body: CreateMaintenanceWindowRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "CreateMaintenanceWindowResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateMaintenanceWindowResponse]:
        """Create a maintenance window
    ...
    def _create_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            base_path='/api/upgrade_policy',
            resource_path='/v2/maintenance_windows',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete(
        ...
        :param id: uuid of a maintenance window record (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DeleteMaintenanceWindowResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteMaintenanceWindowResponse]:
        """Delete maintenance window
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            base_path='/api/upgrade_policy',
            resource_path='/v2/maintenance_windows/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get(
        ...
        _param = self._get_serialize(id=id,
                                     _request_auth=_request_auth,
                                     _content_type=_content_type,
                                     _headers=_headers,
                                     _host_index=_host_index)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetMaintenanceWindowResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetMaintenanceWindowResponse]:
        """Read a maintenance window
    ...
    def list(
        ...
        window_type: Annotated[
            Optional[StrictStr],
            Field(description="window type (software or config).")] = None,
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
                                Tuple[Annotated[StrictFloat,
                                                Field(gt=0)],
        ...
        :param window_type: window type (software or config).
        ...
        _param = self._list_serialize(window_type=window_type,
                                      _request_auth=_request_auth,
                                      _content_type=_content_type,
                                      _headers=_headers,
                                      _host_index=_host_index)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListMaintenanceWindowResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListMaintenanceWindowResponse]:
        """List all the maintenance windows
    ...
    def _list_serialize(
        ...
        if window_type is not None:
            ...
            _query_params.append(('window_type', window_type))
    ...
    def update(
        ...
        :type id: str
        :param body: (required)
        :type body: UpdateMaintenanceWindowRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "UpdateMaintenanceWindowResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout)
        response_data.read()
    ...
    def update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateMaintenanceWindowResponse]:
        """Update an existing maintenance window
