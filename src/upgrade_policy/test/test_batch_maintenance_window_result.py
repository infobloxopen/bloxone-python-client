...
class TestBatchMaintenanceWindowResult(unittest.TestCase):
    """BatchMaintenanceWindowResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchMaintenanceWindowResult:
        """Test BatchMaintenanceWindowResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchMaintenanceWindowResult`
        """
        model = BatchMaintenanceWindowResult()
        if include_optional:
            return BatchMaintenanceWindowResult(
                created_ids = [
                    ''
                    ],
                updated_mws = [
    ...
    def testBatchMaintenanceWindowResult(self):
        """Test BatchMaintenanceWindowResult"""
