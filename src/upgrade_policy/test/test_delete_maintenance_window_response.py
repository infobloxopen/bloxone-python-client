...
class TestDeleteMaintenanceWindowResponse(unittest.TestCase):
    """DeleteMaintenanceWindowResponse unit test stubs"""
    ...
    def make_instance(self,
                      include_optional) -> DeleteMaintenanceWindowResponse:
        """Test DeleteMaintenanceWindowResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteMaintenanceWindowResponse`
        """
        model = DeleteMaintenanceWindowResponse()
        if include_optional:
    ...
    def testDeleteMaintenanceWindowResponse(self):
        """Test DeleteMaintenanceWindowResponse"""
