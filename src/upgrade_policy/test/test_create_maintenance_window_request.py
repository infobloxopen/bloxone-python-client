...
class TestCreateMaintenanceWindowRequest(unittest.TestCase):
    """CreateMaintenanceWindowRequest unit test stubs"""
    ...
    def make_instance(self,
                      include_optional) -> CreateMaintenanceWindowRequest:
        """Test CreateMaintenanceWindowRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateMaintenanceWindowRequest`
        """
        model = CreateMaintenanceWindowRequest()
        if include_optional:
            return CreateMaintenanceWindowRequest(
                payload = upgrade_policy.models.create_maintenance_window_structure_which_includes_schedule_window,_defer_window_and_tags.Create maintenance window structure which includes schedule window, defer window and tags(
    ...
    def testCreateMaintenanceWindowRequest(self):
        """Test CreateMaintenanceWindowRequest"""
