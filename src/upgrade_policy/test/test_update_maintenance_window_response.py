...
class TestUpdateMaintenanceWindowResponse(unittest.TestCase):
    """UpdateMaintenanceWindowResponse unit test stubs"""
    ...
    def make_instance(self,
                      include_optional) -> UpdateMaintenanceWindowResponse:
        """Test UpdateMaintenanceWindowResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMaintenanceWindowResponse`
        """
        model = UpdateMaintenanceWindowResponse()
        if include_optional:
    ...
    def testUpdateMaintenanceWindowResponse(self):
        """Test UpdateMaintenanceWindowResponse"""
