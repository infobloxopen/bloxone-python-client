...
class TestApplyConfigNowStatus(unittest.TestCase):
    """ApplyConfigNowStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplyConfigNowStatus:
        """Test ApplyConfigNowStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplyConfigNowStatus`
        """
        model = ApplyConfigNowStatus()
        if include_optional:
            return ApplyConfigNowStatus(
                hostid = '',
                ophid = '',
                status_code = 'SUCCESS'
            )
    ...
    def testApplyConfigNowStatus(self):
        """Test ApplyConfigNowStatus"""
