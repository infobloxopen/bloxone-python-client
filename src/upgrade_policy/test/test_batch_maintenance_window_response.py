...
class TestBatchMaintenanceWindowResponse(unittest.TestCase):
    """BatchMaintenanceWindowResponse unit test stubs"""
    ...
    def make_instance(self,
                      include_optional) -> BatchMaintenanceWindowResponse:
        """Test BatchMaintenanceWindowResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchMaintenanceWindowResponse`
        """
        model = BatchMaintenanceWindowResponse()
        if include_optional:
            return BatchMaintenanceWindowResponse(
                result = upgrade_policy.models.service_v2_batch_maintenance_window_result.service_v2BatchMaintenanceWindowResult(
                    created_ids = [
                        ''
                        ], 
                    updated_mws = [
                        upgrade_policy.models.maintenance_window_structure_which_includes_schedule_window,_defer_window_and_tags.Maintenance window structure which includes schedule window, defer window and tags(
    ...
    def testBatchMaintenanceWindowResponse(self):
        """Test BatchMaintenanceWindowResponse"""
