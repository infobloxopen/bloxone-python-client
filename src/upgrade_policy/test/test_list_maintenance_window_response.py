...
class TestListMaintenanceWindowResponse(unittest.TestCase):
    """ListMaintenanceWindowResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMaintenanceWindowResponse:
        """Test ListMaintenanceWindowResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMaintenanceWindowResponse`
        """
        model = ListMaintenanceWindowResponse()
        if include_optional:
    ...
    def testListMaintenanceWindowResponse(self):
        """Test ListMaintenanceWindowResponse"""
