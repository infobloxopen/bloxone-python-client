...
class TestUpdateMaintenanceWindow(unittest.TestCase):
    """UpdateMaintenanceWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMaintenanceWindow:
        """Test UpdateMaintenanceWindow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMaintenanceWindow`
        """
        model = UpdateMaintenanceWindow()
        if include_optional:
    ...
    def testUpdateMaintenanceWindow(self):
        """Test UpdateMaintenanceWindow"""
