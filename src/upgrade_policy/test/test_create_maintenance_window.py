...
class TestCreateMaintenanceWindow(unittest.TestCase):
    """CreateMaintenanceWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateMaintenanceWindow:
        """Test CreateMaintenanceWindow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateMaintenanceWindow`
        """
        model = CreateMaintenanceWindow()
        if include_optional:
