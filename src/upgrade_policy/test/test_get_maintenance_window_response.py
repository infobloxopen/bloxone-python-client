...
class TestGetMaintenanceWindowResponse(unittest.TestCase):
    """GetMaintenanceWindowResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMaintenanceWindowResponse:
        """Test GetMaintenanceWindowResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMaintenanceWindowResponse`
        """
        model = GetMaintenanceWindowResponse()
        if include_optional:
            return GetMaintenanceWindowResponse(
                result = upgrade_policy.models.maintenance_window_structure_which_includes_schedule_window,_defer_window_and_tags.Maintenance window structure which includes schedule window, defer window and tags(
    ...
    def testGetMaintenanceWindowResponse(self):
        """Test GetMaintenanceWindowResponse"""
