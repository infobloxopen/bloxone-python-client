...
class TestUpdateBatchMaintenanceWindow(unittest.TestCase):
    """UpdateBatchMaintenanceWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateBatchMaintenanceWindow:
        """Test UpdateBatchMaintenanceWindow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBatchMaintenanceWindow`
        """
        model = UpdateBatchMaintenanceWindow()
        if include_optional:
            return UpdateBatchMaintenanceWindow(
    ...
    def testUpdateBatchMaintenanceWindow(self):
        """Test UpdateBatchMaintenanceWindow"""
